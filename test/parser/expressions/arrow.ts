...
fail('Expression - Arrows (fail)', [
  ...
  * a`,
  ...
  ['(function *g(z = ( x, y=f(yield) ) => {}) { });', Context.Empty],
  ...
  ['([ x + y ]) => {}', Context.Empty],
  ['(x = delete ((var) = f)) => {}', Context.Empty],
  ['(x = delete ((typeof) = f)) => {}', Context.Empty],
  ['(x = delete ((try) = f)) => {}', Context.Empty],
  ['(x = delete ((switch) = f)) => {}', Context.Empty],
  ['(x = (true) = f) => {}', Context.Empty],
  ...
  ['([a], a, ...b) => {}', Context.Empty],
  ['(x = (finally) = f) => {}', Context.Empty],
  ['(x = (else) = f) => {}', Context.Empty],
  ['([a,b,c]) => { const c = x; }', Context.OptionsDisableWebCompat],
  ...
  [`(10) => 0;`, Context.Empty],
  [`"use strict"; (a, a) => 42;`, Context.Empty],
  ['{} => {}', Context.Empty],
  ['(eval) => { "use strict"; 42 }', Context.Empty],
  ['"use strict"; (eval, a) => 42;', Context.Empty],
  ['"use strict"; (a) => 00;', Context.Empty],
  ['"use strict"; (arguments, a) => 42;', Context.Empty],
  ['"use strict"; eval => 42;', Context.Empty],
  ['((a)) => 42;', Context.Empty],
  ['a++ => {}', Context.Empty],
  ['(a++) => {}', Context.Empty],
  ['(a++, b) => {}', Context.Empty],
