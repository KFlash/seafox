...
fail('Expressions - Class (fail)', [
  ...
  ['class foo {}; var foo;', Context.Empty],
  ...
  ['class foo { async x : 0 }', Context.Empty],
  ['class foo { async : 0 }', Context.Empty],
  ['class foo { async static x(){} }', Context.Empty],
  ...
  ['(class x{async *get 8(){}})', Context.Empty],
  ['(class x{static *async 8(){}})', Context.Empty],
