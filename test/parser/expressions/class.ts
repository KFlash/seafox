...
fail('Expressions - Class (fail)', [
  ...
  ['class A { static f([a, a]){} }', Context.Empty],
  ['class A { static f({a, a}){} }', Context.Empty],
  ['class foo {}; class foo {};', Context.Empty],
  ['class foo {}; const foo = 1;', Context.Empty],
  ['class foo {}; function foo () {};', Context.Empty],
  ['class foo {}; let foo = 1;', Context.Empty],
  ['class foo {}; var foo;', Context.Strict | Context.Module],
  ['class o {f(x) { let x }}', Context.Empty],
  ['class o {f(x) { const x = y }}', Context.Empty],
  ['class o {f([b, a], b=x) {}}', Context.Empty],
  ['class o {f(){ let x; var x; }}', Context.Empty],
  ['class o {f(){ var x; let x; }}', Context.Empty],
  ['class o {f(){ const x = y; var x; }}', Context.Empty],
  ['class o {f(){ var x; const x = y; }}', Context.Empty],
  ['class o {f(){ let x; function x(){} }}', Context.Empty],
  ['class o {f(){ function x(){} let x; }}', Context.Empty],
  ['class o {f(b, a, b, a, [fine]) {}}', Context.Empty],
  ['class o {f(b, a, b, a = x) {}}', Context.Empty],
  ['class o {f(b, a, b, ...a) {}}', Context.Empty],
  ['class o {f([a, b, a]) {}}', Context.Empty],
  ['class o {f([b, a, a]) {}}', Context.Empty],
  ['class o {f([b, a, b, a]) {}}', Context.Empty],
  ['class o {f([b, a], b) {}}', Context.Empty],
  ['class o {f([b, a], {b}) {}}', Context.Strict | Context.Module],
  ['class o {f([b, a], b=x) {}}', Context.Empty],
  ['class o {f([b, a], ...b) {}}', Context.Empty],
  ['class o {f(a, b, a) {}}', Context.Empty],
  ['class x {set set __proto__(f){};get get(){}get [super.foo](){}async *[s](){}}', Context.Empty],
  ['let Y = class extends super() {;get get async *"__proto__"(){}}', Context.Empty],
  ['class x extends y { B() { a, class D extends super() {* * set 3.(d){};;} } }', Context.Empty],
  ['class Y {;* get [1](){}set get(b){};get set(){}}', Context.Empty],
  ['class P {set "constructor"(E){};async *"x"(){};get l(){}}', Context.Empty],
  ['class C {;;;async "x"(){}get get async(){}}', Context.Empty],
  ['class Y extends super.foo {;;set 3.(x){};;}', Context.Empty],
  ['class x extends y { i() { a, class {async *constructor(){}async set(){}async *"__proto__"(){}} } }', Context.Empty],
  ['class q extends super() {;;get [.2](){}}', Context.Empty],
  ['class u extends super.foo {;get get M(){};async set set(H){};}', Context.Empty],
  ['class b extends [] {set async *3.(){};get get(){}}', Context.Empty],
  ['class q extends super.foo {;;set async(L){};}', Context.Empty],
  ['class i {;async *async(){}* async *4e5(){};}', Context.Empty],
  ['class l extends {} {;;get set "y"($){}async *"constructor"(){}* set async(i){}}', Context.Empty],
  ['class x { b() { a, class extends super() {;async *"x"(){}} } }', Context.Empty],
  ['class f {set async *set(){};* set get(C){};set async set(){}}', Context.Empty],
  ['class extends super() {;set B(x){};;}', Context.Empty],
  ['let B = class t extends super() {get ["y"](){};}', Context.Empty],
  ['async function *o(){ a, class {get async get(){};async async(){}} }', Context.Empty],
  ['class W extends super.foo {get set set(t){}async set set get "x"(){}async *d(){};;}', Context.Empty],
  ['class o {f(a, a) {}}', Context.Empty],
  ['class o {f(a, b, a) {}}', Context.OptionsDisableWebCompat],
  ['class o {f(b, a, a) {}}', Context.OptionsDisableWebCompat],
  ['class o {f(a, a, b) {}}', Context.Empty],
  ['class o {f(b, a, a) {}}', Context.Strict | Context.Module],
  ['class o {f(a, a, b) {}}', Context.Strict | Context.Module],
  ['class o {f(b, a, b, a) {}}', Context.Empty],
  ...
  [`class A {**=f(){}}`, Context.Empty],
  ['class A { *async x(){} }', Context.Empty],
  ['class A { async *(){} }', Context.Empty],
  ['class foo { async get x(){} }', Context.Empty],
  ['class foo { async set x(y){} }', Context.Empty],
  ['class foo { async x : 0 }', Context.Strict | Context.Module],
  ['class foo { async : 0 }', Context.Strict | Context.Module],
  ['class foo { async static x(){} }', Context.Strict | Context.Module],
  ['class foo { "static *async x(){} }', Context.Empty],
  ['class foo { static async *(){} }', Context.Empty],
  ['class foo { static async get x(){} }', Context.Empty],
  ['class foo { static async set x(y){} }', Context.Empty],
  ['class foo { static async x : 0 }', Context.Empty],
  ['class yield { }', Context.Empty],
  ['class x { x = new y<a>() }', Context.Strict | Context.Module],
  ['class x { x = new y<a,>() }', Context.Empty],
  ['class x { x = new y<a,b>() }', Context.Strict | Context.Module],
  ['class x { x = y<a>() }', Context.Empty],
  ['class x { x = new y<a,>() }', Context.Empty],
  ['class x { x = new y<a,b>() }', Context.Empty],
  ['class x { x = new y<a>() }', Context.Strict | Context.Module],
  ['class x { x = new y<a,>() }', Context.Empty],
  ['class x { x = new y<a,b>() }', Context.OptionsDisableWebCompat],
  ['class eval { }', Context.Empty],
  ['class let { }', Context.Empty],
  ['function *f(){  class yield { }  }', Context.Empty],
  ['function *f(){  class x extends yield { }  }', Context.Empty],
  ['function *f(){  class x extends yield y { }  }', Context.Empty],
  ['class a { b(c,,) {} }', Context.Empty],
  ['(class a { b(c,,) {} })', Context.Empty],
  ...
  ['(class b {#a:})', Context.Empty],
  ['(class x {foo: x})', Context.Strict | Context.Module],
  ['(class x { y })', Context.Strict | Context.Module],
  ...
  ['(class A {async get 7(){}})', Context.Strict | Context.Module],
  ['(class A {* get 8(){}})', Context.Empty],
  ['(class A {get prototype(){}})', Context.Empty],
  ['(class A {set prototype(x){}})', Context.Empty],
  ['(class A {*prototype(){}})', Context.Empty],
  ['class x { get prototype(){} }', Context.OptionsDisableWebCompat],
  ['(class x { async prototype(){} })', Context.Empty],
  ['class x { static set prototype(x){} }', Context.Empty],
  ['class x { static *prototype(){} }', Context.Empty],
  ['class x extends ()=>1 {}', Context.Empty],
  ['class X { async constructor() {} }', Context.Empty],
  ...
  ['(class x{set *foo(a){})', Context.OptionsDisableWebCompat],
  ['(class x{set *[x](a){}})', Context.OptionsDisableWebCompat],
  ['(class x{set *"foo"(a){}})', Context.Empty],
  ['(class x{set *555(a){}})', Context.Empty],
  ['(class x{set *%x(a){}})', Context.Empty],
  ['(class x{static *%x(){}})', Context.Strict | Context.Module],
  ...
  ['class x { static static f(){} }', Context.Empty],
  ['(class x{async *get 8(){}})', Context.Strict | Context.Module],
  ['(class x{static *async 8(){}})', Context.Strict | Context.Module],
  ['(class x{static *get 8(){}})', Context.Empty],
  ['(class x{static *set 8(y){}})', Context.Empty],
  ['(class x{static *async "x"(){}})', Context.Empty],
  ['(class x{static *get "x"(){}}', Context.Empty],
  ['(class { static *get [x](){}})', Context.Empty],
  ['(class { static *get [x](){}}) (class { static *get [x](){}})', Context.Empty],
  ['var foo = (class { static *get [x](){}})', Context.Empty],
  ['(class { static *set [x](y){}})', Context.Empty],
  ['class x { * * f(){} }', Context.Empty],
  ['class x { set set f(x){} }', Context.Empty],
  ['class x { static prototype(){} }', Context.Empty],
  ['class x { static async *prototype(){} }', Context.Empty],
  ['class x { static async *prot\\u006ftype(){} }', Context.Empty],
  ['class x { static "prototype"(){} }', Context.Empty],
  ['class x {foo}', Context.Strict | Context.Module],
  ['class x {foo: x}', Context.Empty],
  ['class x extends await y { }', Context.Empty],
  ['class x extends feh(await y) { }', Context.Empty],
  [`class x{   async static static(){}    }`, Context.Empty],
  [`class x { y }`, Context.Empty],
  [`class v extends.foo {}`, Context.Empty],
  ...
  ['class A extends --x {}', Context.Empty],
  ['class A extends -x {}', Context.Empty],
  ['class A extends a !== b {}', Context.Empty],
  ['class A extends a *= b {}', Context.Empty],
  ['class A extends a + b {}', Context.Strict | Context.Module],
  ['class A extends a = b {}', Context.Empty],
  ['class A extends a => b {}', Context.Empty],
  ['class A extends a => {} {}', Context.Empty],
  ['class A extends async a => {} {}', Context.OptionsDisableWebCompat],
  ['class A extends async function f(){} {}', Context.OptionsDisableWebCompat],
  ['class A extends async function *f(){} {}', Context.Strict | Context.Module],
  [
  ...
  ['class A extends await x {}', Context.Empty],
  [
    `class A extends await
  x; {}`,
    Context.Empty
  ],
  ['class A extends delete x {}', Context.Empty],
  ['class A extends new.target {}', Context.Empty],
  ['class A extends oh,no {}', Context.Empty],
  ['class A extends s ** y {}', Context.Empty],
  ['class A extends super() {}', Context.Empty],
  ['class A extends super.foo {}', Context.Empty],
  ['class A extends typeof x {}', Context.Empty],
  ['class A extends void x {}', Context.Empty],
  ['class A extends !x {}', Context.Empty],
  ['class A extends "oct \\03 al" {}', Context.Empty],
  ['class A extends (a, b) => {} {}', Context.Empty],
  ['class A extends (a) => x {}', Context.Empty],
  ['class A extends () => x {}', Context.Empty],
  ['class A extends +x {}', Context.Empty],
  ['class A extends {...x=y} = b {}', Context.Empty],
  ['class A extends {x: y} = b {}', Context.Empty],
  ['class A extends yield {}', Context.Empty],
  [
  ...
  ['class A extends ~x {}', Context.Empty],
  ['class A extends {x} = b {}', Context.Empty],
  ['function *a() { class yield() {} }', Context.Empty],
