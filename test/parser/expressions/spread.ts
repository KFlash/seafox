...
describe('Expressions - Spread', () => {
  for (const arg of [
    ...
    it(`function fn() { 'use strict';${arg}} fn();`, () => {
      t.throws(() => {
        parseScript(`function fn() { 'use strict';${arg}} fn();`);
      });
    });
    it(`x = ${arg};`, () => {
      t.throws(() => {
  ...
  for (const arg of [
    ...
    `function fn() { 'use strict';{* ...foo}} fn();`,
    `function fn() { 'use strict';{get ...foo}} fn();`,
    `function fn() { 'use strict';{ ...var z = y}} fn();`,
    `function fn() { 'use strict';{ ...var}} fn();`,
    '({get x() {}}) => {}',
    'let {...x, ...y} = {}',
    '({...x,}) => z',
    '(([a, ...b = 0]) => {})',
