...
fail('Expressions - Call (fail)', [
  ['async({a=1}. {b=2}, {c=3} = {}))', Context.Empty],
  ['yield({a=1}. {b=2}, {c=3} = {}))', Context.Empty],
  ['async(call((await[1])=> {}))', Context.Empty],
  ['async(((await[1])=> {}))', Context.Empty],
  ['async(call((await[1]) {}))', Context.Empty],
  ['a.b( c() ).d.e(()).f.g', Context.Empty],
  ['x = {x: [{a = b}] + x}.x', Context.Empty],
...
pass('Expressions - Call (pass)', [
  ...
  [
    `function fn() { 'use strict';} fn(async()());`,
    Context.OptionsLoc,
    {
      type: 'Program',
      sourceType: 'script',
  ...
  [
    `function fn() { 'use strict';} fn(async(a)(b));`,
    Context.OptionsLoc,
    {
      type: 'Program',
      sourceType: 'script',
