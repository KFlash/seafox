...
fail('Expressions - Async Arrow (fail)', [
  ...
  ['async (a, b, a) => {}', Context.OptionsDisableWebCompat],
  ['async (b, a, a) => {}', Context.OptionsDisableWebCompat],
  ['async (a, a, b) => {}', Context.OptionsDisableWebCompat],
  ...
  ['async (x = class { p = await }) => {};', Context.OptionsDisableWebCompat],
  ...
  ['async ([b, a], b) => {}', Context.OptionsDisableWebCompat],
  ['async ([b, a], {b}) => {}', Context.OptionsDisableWebCompat],
  ['async ([b, a], b=x) => {}', Context.OptionsDisableWebCompat],
  ['async ([a], a, ...b) => {}', Context.OptionsDisableWebCompat],
  ...
  ['(async (a = b => { let b; }))', Context.OptionsDisableWebCompat],
  ['(async yield => { let yield; })', Context.OptionsDisableWebCompat],
  ['async(a = await => 1, b = async() => 1);', Context.Empty],
  ...
  ['([ class{} ]) => {}', Context.Empty],
  ['async (x = delete ((this) = f)) => {}', Context.Empty],
  ['async () => {}\n/x', Context.Empty],
  ['async () => {}\n/ x / g', Context.Empty],
  ...
  ['async (x = delete ((if) = f)) => {}', Context.Empty],
  ['async (x = delete ((export) = f)) => {}', Context.Empty],
  ['async (x = (with) = f) => {}', Context.Empty],
  ...
  ['async(a = (b = await/r/g) => x) => {}', Context.Empty],
...
pass('Expressions - Async arrow (pass)', [
  ...
  [
    `async ({x}, y, [z], v) => { var x, y, z; return x*y*z*v }`,
    Context.OptionsLoc,
    {
      type: 'Program',
      sourceType: 'script',
  ...
  [
    `async ({x}) => { { var g = () => x; var x = 2; } return g(); }`,
    Context.OptionsLoc,
    {
      type: 'Program',
      sourceType: 'script',
