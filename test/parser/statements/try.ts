...
fail('Statements - Try (fail)', [
  ['try { throw 0; } catch(e) { let {f, g} = 0, {e} = 0 }', Context.Empty],
  ['try { throw 0; } catch(e) { const e = 0 }', Context.Empty],
  ['try { throw 0; } catch(e) { const f = 0, g = 0, e = 0 }', Context.Empty],
  ['try { throw 0; } catch(e) { const {f:e} = 0 }', Context.Empty],
  ['try { throw 0; } catch(e) { const [[[], e]] = 0}', Context.Empty],
  ['try { throw 0; } catch(e) { function e(){} }', Context.Empty],
  ['try { throw 0; } catch(e) { let [f] = [], [] = [], e = e, h }', Context.Empty],
  ['try { throw 0; } catch(e) { let f, g, e }', Context.Empty],
  ['try { throw 0; } catch({e}) { function* e(){} }', Context.Empty],
  ['try { throw 0; } catch({e}) { let {f:e} = 0 }', Context.Empty],
  ['try { throw 0; } catch({e}) { let {f, e} = 0 }', Context.Empty],
  ['try { throw 0; } catch({e}) { let e }', Context.Empty],
  ['try { throw 0; } catch(e) { let {e} = 0 }', Context.Empty],
  ['try { throw 0; } catch(e) { const [[[], e]] = 0 }', Context.Empty],
