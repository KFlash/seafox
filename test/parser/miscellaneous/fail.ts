...
fail('Miscellaneous - Fail', [
  ...
  [' function f(a, ...b, c){}', Context.OptionsRaw],
  [' with(true) function a(){}', Context.OptionsRaw],
  ...
  [' var new A = 0;', Context.OptionsRaw],
  ['({get ', Context.OptionsRaw],
  ['0b1a', Context.OptionsRaw],
  ['yield v', Context.OptionsRaw],
  ...
  ['for( in y);', Context.OptionsRaw],
  ['for(* in y);', Context.OptionsRaw],
  ['for(x* in y);', Context.OptionsRaw],
  ['for(a?b:x* in y);', Context.OptionsRaw],
  ['for(a?b:* in y);', Context.OptionsRaw],
  ['for(var x=a* in y);', Context.OptionsRaw],
  ['for(var x=u?i:a* in y);', Context.OptionsRaw],
  ['for(*;;);', Context.OptionsRaw],
  ...
  ['new typeof foo', Context.OptionsRaw],
  ...
  ['/foo*', Context.OptionsRaw],
  ['/f+oo', Context.OptionsRaw],
  ['/fo+o', Context.OptionsRaw],
  ['/f.o', Context.OptionsRaw],
