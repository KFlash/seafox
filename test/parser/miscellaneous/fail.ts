...
describe('Miscellaneous - Failure', () => {
  for (const arg of [
    ...
    '!function* package(){"use strict";} ',
    'function a() {"use strict"; (function arguments() { }()) }',
    ...
    '100000000000000000000000000000000e12n',
    'import(',
    'import()',
    '`test${',
    '`test${}test`',
    ...
    'function * gen() { var {foo: yield} = {a: 42}; }',
    'function * gen() { ({a: yield} = {a: 42}); }',
    'function * gen() { ({a: yield 24} = {a: 42});  }',
    'function * gen() { for (yield "x" of {});  }',
    'function * gen() { class C extends yield { } }',
    'function * gen() { var [yield] = [42]; }',
...
`,
  ...
  */]`,
    ...
    'async function f(){ (fail = class A {async [x](await){}; "x"(){}}) => {} }',
