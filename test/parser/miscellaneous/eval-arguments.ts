...
for (const arg of [
  ...
  it(`${arg}`, () => {
    t.throws(() => {
      parseRoot(`o = {foo(${arg}){ "use strict"; }}`, Context.Empty);
    });
  });
  it(`${arg}`, () => {
    t.throws(() => {
  ...
  it(`'use strict'; for (${arg} of {}) {}`, () => {
    t.throws(() => {
      parseRoot(`'use strict'; for (${arg} of {}) {}`, Context.Empty);
    });
  });
  it(`'use strict'; for (${arg} of {}) {}`, () => {
    t.throws(() => {
      parseRoot(`'use strict'; for (${arg} of {}) {}`, Context.Strict | Context.Module);
    });
  });
  it(`for (${arg} in {}) {}`, () => {
    t.throws(() => {
      parseRoot(`for (${arg} in {}) {}`, Context.Strict);
    });
  });
}
...
for (const arg of [
  ...
  it(`${arg}`, () => {
    t.throws(() => {
      parseRoot(`${arg}`, Context.OptionsDisableWebCompat | Context.Strict);
    });
  });
...
for (const arg of [
  ...
  it(`() => { "use strict";  ${arg} }`, () => {
    t.doesNotThrow(() => {
      parseRoot(`() => { "use strict";  ${arg} }`, Context.Strict | Context.Module);
    });
  });
}
