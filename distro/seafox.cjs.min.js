...
function scan(e, t, n, r, o, s, a, i, p) {
  ...
  for (; e.index < o; ) {
    if (((l = n.charCodeAt(e.index)), (e.line = e.lineBase), (e.column = (e.start = e.index) - e.offset), l > 126)) {
      ...
      return scanMaybeIdentifier(e, t, n, l);
    }
...
function addBlockName(e, t, n, r, o, s) {
  ...
  a &&
    ...
    64 & n.type && n.parent['#' + r] && 8 != (8 & n.parent['#' + r]) && report(e, 22, r),
    512 & n.type && a && 8 != (8 & a) && 1 == (1 & o) && (n.scopeError = recordScopeError(e, 22, r)),
    32 & n.type && 768 & n.parent['#' + r] && report(e, 23, r),
    (n['#' + r] = o);
}
...
function parseArrowFunction(e, t, n, r, o, s, a, i) {
  ...
  let l;
  if ((n && void 0 !== n.scopeError && reportScopeError(n.scopeError), p)) l = parseExpression(e, t, 0);
  else if (
    ((l = parseFunctionBody(e, 402657280 ^ (402657280 | t), n, void 0, 1, void 0)),
...
function parseParenthesizedExpression(e, t, n, r, o, s, a, i, p) {
  nextToken(e, t, 1);
  const l = { parent: { parent: void 0, type: 2 }, type: 512, scopeError: void 0 };
  (e.flags = 3328 ^ (3328 | e.flags)), (t = 8192 ^ (8192 | t));
  let c = [];
  if (17 === e.token) return 0 === r && report(e, 73), nextToken(e, t, 0), parseArrowFunction(e, t, l, c, 0, a, i, p);
  let d = [],
    u = 0,
    x = 0;
  ...
  for (e.assignable = 1; 17 !== e.token; ) {
    ...
    if (2555904 & r)
      addBlockName(e, t, l, y, 1, 0),
        (c = parsePrimaryExpression(e, t, o, 0, 1, 1, 1, a, i, p)),
        19 === e.token || 17 === e.token
          ...
          : ((x |= 67108896 === e.token ? 256 : 8),
            (c = parseMemberExpression(e, t, c, 0, 0, n, a, i, p)),
            17 !== e.token && 19 !== e.token && (c = parseAssignmentExpression(e, t, 0, 1, c, a, i, p)));
    else {
      if (!(33554432 & r)) {
        if (15 === r) {
          (c = parseSpreadOrRestElement(e, t, l, 17, 0, 0, 0, o, s, a, i, p)),
            8 & e.flags && report(e, 63),
            !u || (17 !== e.token && 19 !== e.token) || d.push(c),
            (x |= 272);
          break;
        }
        if (
          ((x |= 8),
          (c = parseExpression(e, t, n)),
          !u || (19 !== e.token && 17 !== e.token) || d.push(c),
          19 === e.token && (u || ((u = 1), (d = [c]))),
          u)
        ) {
        ...
        return consume(e, t, 17, 0), (e.flags = (30 ^ (30 | e.flags)) | x), c;
      }
      (c =
        34603021 === e.token
          ? parseObjectLiteralOrPattern(e, t, l, 0, 0, 1, o, s, a, i, p)
          : parseArrayExpressionOrPattern(e, t, l, 0, 0, 1, o, s, a, i, p)),
        (x |= 256 | e.flags),
        (e.assignable = 0),
        19 !== e.token &&
          17 !== e.token &&
          (16 & x && report(e, 64),
          (c = parseMemberExpression(e, t, c, 0, 0, 0, a, i, p)),
          (x |= 8),
          19 !== e.token && 17 !== e.token && (c = parseAssignmentExpression(e, t, 0, 0, c, a, i, p)));
    }
    if ((!u || (19 !== e.token && 17 !== e.token) || d.push(c), 19 !== e.token)) break;
    if ((nextToken(e, t, 1), u || ((u = 1), (d = [c])), 17 === e.token)) {
      x |= 16;
      break;
    }
  }
  return (
    ...
    11 === e.token
      ? (4196352 & t && 2048 & x && report(e, 37), parseArrowFunctionAfterParen(e, t, l, x, u ? d : [c], r, 0, a, i, p))
      : (16 & x && report(e, 75), (e.flags = (30 ^ (30 | e.flags)) | x), c)
  );
}
...
function parseArrayExpressionOrPattern(e, t, n, r, o, s, a, i, p, l, c) {
      ...
      if (
        (2555904 & p
          ? ((r = parsePrimaryExpression(e, t, a, 0, 1, 1, s, l, c, x)),
            67108896 === e.token
              ? (0 === e.assignable && report(e, 60),
                ...
                (r = parseAssignmentOrPattern(e, t, o, s, r, '=', l, c, x)))
              ...
              : ((u |= 1 & a ? 4 : 8 != (8 & a) ? 8 : 0),
                ...
                19 !== e.token && 21 !== e.token
                  ? (67108896 !== e.token && (u |= 8), (r = parseAssignmentExpression(e, t, o, 0, r, l, c, x)))
          ...
          ? ((r =
            ...
            19 === e.token || 21 === e.token
              ...
              : (16 & e.flags && report(e, 56),
                ...
                19 !== e.token && 21 !== e.token
                  ? (r = parseAssignmentExpression(e, t, o, 0, r, l, c, x))
                  : 67108896 !== e.token && (u |= 0 === e.assignable ? 8 : 4)))
          : 15 === p
          ...
          : ((r = parseLeftHandSideExpression(e, t, 0, 1, 1)),
            19 !== e.token && 21 !== e.token
              ? ((r = parseAssignmentExpression(e, t, o, 0, r, l, c, x)), 0 == (9 & a) && 1048588 === p && (u |= 8))
              : 0 === e.assignable
              ? (u |= 8)
  ...
  consume(e, t, 21, 0);
  const x = o ? 'ArrayPattern' : 'ArrayExpression',
    m = 2 & t ? { type: x, elements: d, start: p, end: e.endIndex, loc: setLoc(e, l, c) } : { type: x, elements: d };
  return 0 === r && 67108864 & e.token
    ? parseArrayOrObjectAssignmentPattern(e, t, u, o, s, p, l, c, m)
...
function parseClassElementList(e, t, n, r, o, s, a, i, p, l, c) {
    ...
    if (((o = parseIdentifier(e, t)), 1048588 !== e.token))
      switch (d) {
        case 262252:
          ...
          break;
        case 2162799:
          0 === e.newLine && (i |= 16 | (optionalBit(e, t, 135314230) ? 8 : 0));
          break;
        case 65650:
          i |= 128;
          break;
  ...
  return 2 & t
    ...
    : { type: 'MethodDefinition', kind: k, static: 0 != (32 & i), computed: 1 === s, key: o, value: f };
}
...
function parseObjectLiteralOrPattern(e, t, n, r, o, s, a, i, p, l, c) {
  ...
  for (; 16777232 !== e.token; ) {
    const { token: r, start: p, line: l, column: c, tokenValue: b } = e;
    if (15 === r) d.push(parseSpreadOrRestElement(e, t, n, 16777232, o, 0, s, a, i, p, l, c));
      ...
      if (((y = 0), 2555904 & r))
        if (((k = parseIdentifier(e, t)), 19 === e.token || 16777232 === e.token || 67108896 === e.token))
          (y |= 4),
            1024 & t && 537919488 == (537919488 & r) ? (m |= 8) : validateIdentifier(e, t, a, r),
            addVarOrBlock(e, t, n, b, a, i),
            67108896 === e.token
              ? ((m |= 16), (u = parseAssignmentOrPattern(e, t, o, s, k, '=', p, l, c)))
              : (1 === s && 3211376 === r && (m |= 2048), (u = k));
        else if (22 === e.token) {
          nextToken(e, t, 1);
                  ...
                  : ((u = parseMemberExpression(e, t, u, 0, 0, 0, p, l, c)),
                    ...
                    67108864 == (67108864 & e.token)
                      ? ((x = KeywordDescTable[255 & e.token]),
                        (u = parseAssignmentOrPattern(e, t, o, 0, u, x, p, l, c)))
                      : (135266304 == (135266304 & e.token) &&
                          (u = parseBinaryExpression(e, t, 0, 0, e.token, p, l, c, u)),
                        23 === e.token && (u = parseConditionalExpression(e, t, u, p, l, c)),
              ...
              : ((u = parseLeftHandSideExpression(e, t, 0, 1, 1)),
                ...
                19 === e.token || 16777232 === e.token
                  ...
                  : ((u = parseMemberExpression(e, t, u, 0, 0, 0, p, l, c)),
                    ...
                    19 !== e.token &&
                      16777232 !== r &&
                      (67108896 !== e.token && (m |= 8), (u = parseAssignmentExpression(e, t, o, 0, u, p, l, c)))));
        } else
          34603028 === e.token
            ? ((m |= 8),
              2162799 === r && (y |= 16),
            ...
            (u = parseMemberExpression(e, t, u, 0, 0, 0, r, p, l)),
              19 === e.token || 16777232 === e.token
                ? 67108896 === c || 16777232 === c || 19 === c
                  ...
                  : (m |= 1 === e.assignable ? 4 : 8)
                : 67108896 === e.token
                ? (0 === e.assignable && (m |= 8), (u = parseAssignmentExpression(e, t, o, 0, u, r, p, l)))
                : ((m |= 8), (u = parseAssignmentExpression(e, t, o, 0, u, r, p, l)));
          } else
            33554432 == (33554432 & e.token)
              ? ((u =
                  34603021 === e.token
                ...
                19 === e.token || 16777232 === e.token
                  ...
                  : ((u = parseMemberExpression(e, t, u, 0, 0, 0, r, p, l)),
                    ...
                    67108864 == (67108864 & e.token)
                      ? ((x = KeywordDescTable[255 & e.token]),
                        (u = parseAssignmentOrPattern(e, t, o, 0, u, x, r, p, l)))
                      : (135266304 == (135266304 & e.token) &&
              ...
              : ((u = parseLeftHandSideExpression(e, t, 0, 1, 1)),
                ...
                19 === e.token || 16777232 === e.token
                  ...
                  : ((u = parseMemberExpression(e, t, u, 0, 0, 0, r, p, l)),
                    ...
                    19 !== e.token &&
                      16777232 !== e.token &&
                      (67108896 !== e.token && (m |= 8), (u = parseAssignmentExpression(e, t, o, 0, u, r, p, l)))));
            ...
            (u = parseMemberExpression(e, t, u, 0, 0, 0, r, p, l)),
              67108864 == (67108864 & e.token)
                ...
                ? 67108896 === f || 16777232 === f || 19 === f
                  ? 0 === e.assignable
                    ? (m |= 8)
                    : n && 2162688 == (2162688 & d) && addVarOrBlock(e, t, n, c, a, i)
                  : (m |= 1 === e.assignable ? 4 : 8)
                : ((m |= 8), (u = parseAssignmentExpression(e, t, o, 0, u, r, p, l)));
          } else
            33554432 == (33554432 & e.token)
  ...
  return 67108864 == (67108864 & e.token) && 0 === r
    ? parseArrayOrObjectAssignmentPattern(e, t, m, o, s, p, l, c, b)
    : ((e.flags = (30 ^ (30 | e.flags)) | m), b);
}
...
function parseBindingPattern(e, t, n, r, o) {
  ...
  if (0 != (2555904 & l)) return parseAndClassifyIdentifier(e, t, n, l, s, r, o, a, i, p, 1);
...
function parseFunctionDeclarationRest(e, t, n, r, o, s, a, i) {
  ...
  return parseFunctionLiteral(
    e,
    (t = (32243712 ^ (32243712 | t)) | 67108864 | ((2 * l + p) << 21)),
    u,
    d,
    c,
    r,
...
function parseLabelledStatement(e, t, n, r, o, s, a, i, p, l, c, d, u) {
  ...
  const x =
    1040 & t || 1179738 !== e.token ? parseStatement(e, t, n, r, o, s, l) : parseFunctionDeclaration(e, t, n, 1, r);
  return 2 & t
...
function parseForStatementWithVariableDeclarations(e, t, n, r, o, s, a, i) {
    ...
    3473483 === p
      ? 0 != (36110336 & e.token)
        ...
        : (1024 & t && report(e, 40),
          ...
          (e.assignable = 1),
          (k = parseMemberExpression(e, t, k, 0, 0, 0, l, c, d)),
          (g = !0))
  ...
  if (139624500 === e.token) {
    ...
    const r = parseStatement(e, 131072 | t, n, 32, o, null, 0);
    return 2 & t
      ? { type: 'ForInStatement', body: r, left: k, right: x, start: s, end: e.endIndex, loc: setLoc(e, a, i) }
      : { type: 'ForInStatement', body: r, left: k, right: x };
  }
  ...
  return 2 & t
    ? { type: 'ForStatement', body: b, init: k, test: m, update: f, start: s, end: e.endIndex, loc: setLoc(e, a, i) }
...
function parseForStatement(e, t, n, r) {
  ...
  if (
    ...
    return 2 & t
      ...
      : { type: 'ForOfStatement', body: l, left: d, right: p, await: i };
  }
  if (139624500 === e.token) {
    0 === e.assignable && report(e, 69, 'in'),
      i && report(e, 0),
...
function parseSwitchStatement(e, t, n, r, o) {
  ...
  for (n = { parent: n, type: 8, scopeError: void 0 }; 16777232 !== e.token; ) {
    ...
    for (
      131155 === e.token && (nextToken(e, t, 1), c && report(e, 101), (c = 1)), consume(e, t, 22, 1);
...
function parseImportDeclaration(e, t, n) {
  ...
  let a = null,
    i = [];
  if (1572868 === e.token) a = parseLiteral(e, t);
  else {
    if (2555904 & e.token) {
      const { start: p, line: l, column: c } = e;
      isValidIdentifier(t, e.token) || report(e, 26),
        537919488 == (537919488 & e.token) && report(e, 27),
        addBlockName(e, t, n, e.tokenValue, 16, 0);
      const d = parseIdentifier(e, t);
      if (
        ((i = [
          2 & t
            ? { type: 'ImportDefaultSpecifier', local: d, start: p, end: e.endIndex, loc: setLoc(e, l, c) }
    ...
    switch (e.token) {
      ...
      case 34603021:
        for (nextToken(e, t, 0); 2555904 & e.token; ) {
          ...
          const l = parseIdentifier(e, t);
          let c;
          consumeOpt(e, t, 65646, 0)
            ? (524288 == (524288 & e.token) || 19 === e.token ? report(e, 105) : validateIdentifier(e, t, 32, e.token),
              (a = e.tokenValue),
  ...
  switch (e.token) {
    ...
    case 135314230:
      if ((nextToken(e, t, 0), consumeOpt(e, t, 65646, 0))) {
        declareUnboundVariable(e, e.tokenValue);
        ...
        return (
          ...
          consume(e, t, 65652, 0),
          1572868 !== e.token && report(e, 104, 'Export'),
          (p = parseLiteral(e, t)),
          expectSemicolon(e, t),
          2 & t
            ? {
    ...
    case 34603021: {
      ...
      if ((consume(e, t, 16777232, 1), 65652 === e.token))
        ...
        let t = n.length;
        for (; t--; ) declareUnboundVariable(e, n[t]);
        for (t = r.length; t--; ) addBindingToExports(e, r[t]);
      }
      expectSemicolon(e, t);
      break;
    }
    ...
    case 2162799: {
      ...
      if ((nextToken(e, t, 0), 0 === e.newLine && 1179738 === e.token)) {
        (i = parseFunctionDeclarationRest(e, t, n, 15, 64, r, o, s)), declareUnboundVariable(e, i.id ? i.id.name : '');
        break;
      }
    }
    default:
