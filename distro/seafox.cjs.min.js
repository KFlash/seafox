...
function skipMultiLineComment(e, t, n) {
  ...
  for (; n < e.length; ) {
    if (s < 43) {
      ...
      13 === s && (e.lineBase++, (e.newLine = r = 1), (e.offset = n)),
        10 === s && (0 === r && e.lineBase++, (r = 0), (e.newLine = 1), (e.offset = n));
...
function scanIdentifier(e, t, n, r) {
  for (; (5 & CharTypes[r]) > 0; ) r = n.charCodeAt(++e.index);
  const s = n.slice(e.start, e.index);
  return r > 90 ? scanIdentifierSlowPath(e, t, n, s, 0, 0) : ((e.tokenValue = s), 3211265);
}
function scanIdentifierOrKeyword(e, t, n, r) {
  for (; (5 & CharTypes[r]) > 0; ) r = n.charCodeAt(++e.index);
  const s = n.slice(e.start, e.index);
  return r > 90 ? scanIdentifierSlowPath(e, t, n, s, 1, 0) : ((e.tokenValue = s), descKeywordTable[s] || 3211265);
}
function scanIdentifierSlowPath(e, t, n, r, s, o) {
  let a = e.index,
  ...
  const l = (r += n.slice(a, e.index)).length;
  if (((e.tokenValue = r), s && l >= 2 && l <= 11)) {
    const t = descKeywordTable[e.tokenValue];
...
function scanUnicodeEscape(e, t) {
  ...
  if (123 === r) {
    ...
    for (s < 0 && report(e, 17); s >= 0; )
      (n = (n << 4) | s), n > 1114111 && report(e, 18), (s = toHex((r = t.charCodeAt(++e.index))));
...
function scanUnicodeEscapeIdStart(e, t, n) {
  ...
  if (isIdentifierPart(r)) return scanIdentifierSlowPath(e, t, n, fromCodePoint(r), 1, 1);
  e.index++, report(e, 19);
}
    ...
    case 117: {
      ...
      if (123 === s) {
        ...
        for (; r >= 0; ) {
          ...
          (s = n.charCodeAt(++e.index)), (r = toHex(s));
        }
      ...
      let r = 0,
        o = null;
      for (r = 0; r < 4; r++) {
        if (((o = toHex(n.charCodeAt(e.index++))), o < 0)) return -4;
        t = (t << 4) | o;
      }
      return t;
    }
  ...
  for (;;) {
    ...
    if ((r++, 1 & o)) o &= -2;
      ...
      if (47 === t) {
        ...
        92 === t ? (o |= 1) : 91 === t ? (o |= 2) : 93 === t ? (o &= 1) : 16 == (16 & CharTypes[t]) && report(e, 12);
  ...
  return 110 === n && 0 === r
    ...
    : (101 == (32 | n) && (n = scanSignedInteger(e, t)),
      95 === n
        ...
        : ((3 & CharTypes[n]) > 0 && report(e, 1), (e.tokenValue = parseFloat(t.slice(e.start, e.index))), 1572866));
}
...
function scanNumberAfterDecimalPoint(e, t, n) {
  ...
  return (
    ...
    95 === n
      ? skipNumericSeparator(e, t, n)
      : ((3 & CharTypes[n]) > 0 && report(e, 1),
        (r = t.slice(e.start, e.index)),
...
function scanImplicitOctalDigits(e, t, n, r) {
  ...
  return 110 === r && report(e, 2), (3 & CharTypes[r]) > 0 && report(e, 1), (e.tokenValue = s), 1572866;
}
function scanOctalDigits(e, t) {
  ...
  return (
    0 === a && report(e, 8),
    110 === r ? scanBigInt(e, t) : ((3 & CharTypes[r]) > 0 && report(e, 1), (e.tokenValue = n), 1572866)
  );
}
function scanHexDigits(e, t) {
  ...
  const s = e.index;
  let o = 7;
  for (; (32 & CharTypes[r]) > 0 && o >= 0; ) (n = (n << 4) | toHex(r)), (r = t.charCodeAt(++e.index)), --o;
  if ((s === e.index && report(e, 9), o >= 0 && 0 == (3 & CharTypes[r]))) return (e.tokenValue = n), 1572866;
  let a = 1;
  for (; (96 & CharTypes[r]) > 0; )
    95 !== r
...
function scanBinaryDigits(e, t) {
  ...
  return (
    0 === a && report(e, 8),
    110 === s ? scanBigInt(e, t) : ((3 & CharTypes[s]) > 0 && report(e, 1), (e.tokenValue = n), 1572866)
  );
}
function scanBigInt(e, t) {
  const n = t.charCodeAt(++e.index);
  return (3 & CharTypes[n]) > 0 && report(e, 1), 1048579;
}
...
function scan(e, t, n, r, s, o, a, i, p) {
  let l;
  for (; e.index < s; ) {
    if (((l = n.charCodeAt(e.index)), (e.line = e.lineBase), (e.column = (e.start = e.index) - e.offset), l > 126)) {
      ...
      if (1 & (unicodeLookup[34816 + (l >>> 5)] >>> l) || 55296 == (64512 & l))
        return scanIdentifierSlowPath(e, t, n, '', 0, 0);
      report(e, 20, fromCodePoint(l));
    }
    switch ((o = firstCharKinds[l])) {
      case 16777232:
      case 34603021:
      case 19:
      case 22:
      ...
      case 135301186:
        ...
        if (33 === l && e.index < s && 45 === n.charCodeAt(e.index + 2) && 45 === n.charCodeAt(e.index + 1)) {
...
function nextToken(e, t, n) {
  ...
  (e.lastColumn = (e.endIndex = o) - a),
    ...
    (e.token = scan(e, t, r, o, s, 16777216, 0, 0 === o, n));
}
...
function addVarOrBlock(e, t, n, r, s, o) {
  2 & s ? addVarName(e, t, n, r, s) : addBlockName(e, t, n, r, s, o), 64 & o && declareUnboundVariable(e, r);
}
...
function addVarName(e, t, n, r, s) {
  ...
  do {
    (o = a['#' + r]),
      (244 & o) > 0 && ((0 == (1040 & t) && (128 & s) > 0) || (128 & o) > 0 || report(e, 22, r)),
      (768 & o) > 0 && ((1040 & t) > 0 || 0 == (512 & o)) && report(e, 22, r),
      (a['#' + r] = s),
      (a = a.parent);
  } while (a && 0 == (128 & a.type));
}
function addBlockName(e, t, n, r, s, o) {
  ...
  a &&
    ...
    ((1 & s) > 0
      ...
      : ((16 & t) > 0 || 0 == (4 & a) || 0 == (2 & o)) && report(e, 22, r));
  const i = n.parent;
...
function parseAssignmentExpression(e, t, n, r, s, o, a, i) {
  return (67108864 & e.token) > 0
    ? (0 === e.assignable && report(e, 60),
      parseAssignmentOrPattern(e, t, n, r, s, KeywordDescTable[255 & e.token], o, a, i))
    : ((135266304 & e.token) > 0 && (s = parseBinaryExpression(e, t, r, 4, e.token, o, a, i, s)),
      23 === e.token ? parseConditionalExpression(e, t, s, o, a, i) : s);
}
function parseExpression(e, t, n) {
  const { start: r, line: s, column: o } = e;
  let a = parsePrimaryExpression(e, t, 0, 0, 1, 1, n, r, s, o);
  return (a = parseMemberExpression(e, t, a, n, r, s, o)), parseAssignmentExpression(e, t, 0, n, a, r, s, o);
}
...
function parseBinaryExpression(e, t, n, r, s, o, a, i, p) {
  let l, c;
  const d = 8192 & t ? 3840 : 61440;
  for (; (135266304 & s) > 0; ) {
    if (((l = e.token), (l & d) + ((135318585 === l) << 8) <= r)) return p;
    (1082130432 & (s | l)) > 1073741824 && report(e, 45),
      nextToken(e, t, 1),
      ...
      (p =
        2 & t
          ? {
              ...
              left: p,
              right: c,
              operator: KeywordDescTable[255 & l],
              start: o,
              end: e.endIndex,
              loc: setLoc(e, a, i)
            }
...
function parsePropertyOrPrivatePropertyName(e, t) {
  if ((2555904 & e.token) > 0) return parseIdentifier(e, t);
  report(e, 95);
}
function parseMemberExpression(e, t, n, r, s, o, a) {
  if (269484032 == (269484032 & e.token)) return 0 === e.newLine ? parseUpdateExpression(e, t, n, s, o, a) : n;
  switch (e.token) {
    case 14: {
      nextToken(e, t, 0), (e.assignable = 1);
      const i = parsePropertyOrPrivatePropertyName(e, t);
    ...
    case 34603028: {
      nextToken(e, t, 1);
      const i = parseExpressions(e, 8192 ^ (8192 | t), r);
      return (
        consume(e, t, 21, 0),
        (e.assignable = 1),
    ...
    case 1048588: {
      ...
      return (
        ...
        parseMemberExpression(
          ...
          t,
          2 & t
            ? { type: 'CallExpression', callee: n, arguments: i, start: s, end: e.endIndex, loc: setLoc(e, o, a) }
    ...
    case 1048586:
      return parseMemberExpression(
        e,
        t,
        parseTemplateExpression(e, t, n, parseTemplateLiteral(e, t), s, o, a),
        r,
        s,
        o,
        a
    ...
    case 1048585:
      return parseMemberExpression(
        e,
        t,
        parseTemplateExpression(e, t, n, parseTemplate(e, 65536 | t, s, o, a), s, o, a),
        r,
        s,
        o,
        a
        ...
        parseMemberExpression(
          ...
          2 & t
            ? {
                ...
                base: n,
                chain: parseMemberOrCallChain(e, t, [], 1, s, o, a),
                start: s,
                end: e.endIndex,
                loc: setLoc(e, o, a)
              }
            : { type: 'ChainingExpression', base: n, chain: parseMemberOrCallChain(e, t, [], 1, s, o, a) },
          r,
          s,
          o,
          a
...
function parseMemberOrCallChain(e, t, n, r, s, o, a) {
  switch (e.token) {
    case 14:
      return (
        nextToken(e, t, 0),
        (e.assignable = 0),
        0 == (2555904 & e.token) && report(e, 95),
        n.push(
          2 & t
            ? {
                type: 'MemberChain',
            ...
            : { type: 'MemberChain', computed: !1, optional: !1, property: parseIdentifier(e, t) }
        ),
        parseMemberOrCallChain(e, t, n, 0, s, o, a)
      );
    case 34603028: {
      nextToken(e, t, 1);
      const r = parseExpressions(e, 8192 ^ (8192 | t), 0);
      return (
        consume(e, t, 21, 0),
        (e.assignable = 0),
        n.push(
          2 & t
            ...
            : { type: 'MemberChain', computed: !0, property: r, optional: !1 }
        ),
        parseMemberOrCallChain(e, t, n, 0, s, o, a)
      );
    }
    case 1048588:
      const i = parseArguments(e, t, 0);
      return (
        (e.assignable = 0),
        n.push(
          2 & t
            ? { type: 'CallChain', arguments: i, optional: !0, start: s, end: e.endIndex, loc: setLoc(e, o, a) }
            : { type: 'CallChain', arguments: i, optional: !0 }
        ),
        parseMemberOrCallChain(e, t, n, 0, s, o, a)
      );
    case 1048586:
    case 1048585:
      report(e, 6);
    case 25:
      nextToken(e, t, 0), 1 === r && report(e, 0), (e.assignable = 0);
    default:
        ...
        return (
          ...
          n.push(
            2 & t
              ...
              : { type: 'MemberChain', computed: !1, property: parseIdentifier(e, t), optional: !0 }
          ),
          parseMemberOrCallChain(e, t, n, 0, s, o, a)
        );
  }
...
function parseArguments(e, t, n) {
  ...
  for (; 17 !== e.token; ) {
      ...
      nextToken(e, t, 1),
        r.push(
          2 & t
            ? {
                type: 'SpreadElement',
                argument: parseExpression(e, t, n),
                start: s,
                end: e.endIndex,
                loc: setLoc(e, o, a)
              }
    ...
    } else r.push(parseExpression(e, t, n));
    if (19 !== e.token) break;
    nextToken(e, t, 1);
  }
  ...
  const i = [
    2 & t
      ? {
          ...
          value: { cooked: o, raw: a },
          tail: !0,
          start: n,
          end: e.endIndex,
          loc: setLoc(e, r, s)
        }
      : { type: 'TemplateElement', value: { cooked: o, raw: a }, tail: !0 }
  ];
  return 2 & t
...
function parseYieldExpression(e, t, n, r, s, o, a) {
  if (((e.flags |= 1 === n ? 1024 : 0), 2097152 & t)) {
    ...
    return (
      ...
      (e.assignable = 0),
      2 & t
        ? { type: 'YieldExpression', argument: n, delegate: 1 === i, start: s, end: e.endIndex, loc: setLoc(e, o, a) }
...
function parseIdentifierOrArrow(e, t) {
  const { start: n, line: r, column: s, token: o, tokenValue: a } = e;
  nextToken(e, t, 0);
  let i = parseIdentifierFromValue(e, t, a, n, r, s);
  if (((e.assignable = 1), 11 === e.token)) {
    e.flags |= 262144 == (262144 & o) ? 64 : 0;
    const a = 256 ^ (256 | e.flags),
      p = { parent: { parent: void 0, type: 2 }, type: 2, scopeError: void 0 };
    addBlockName(e, t, p, e.tokenValue, 1, 0), (i = parseArrowFunction(e, t, p, [i], 0, n, r, s)), (e.flags |= a);
  }
  return i;
}
function parsePrimaryExpression(e, t, n, r, s, o, a, i, p, l) {
  const c = e.token;
  if (2162688 == (2162688 & c)) {
    if (3473517 === c) return parseYieldExpression(e, t, a, o, i, p, l);
    if (3211376 === c) return parseAwaitExpression(e, t, a, r, i, p, l);
    if (2162799 === c) return parseAsyncExpression(e, t, r, s, o, i, p, l);
  ...
  if (269484032 == (269484032 & c)) return parseUpdateExpressionPrefix(e, t, r, s, i, p, l);
  switch (c) {
    case 1179694:
    case 1048624:
    case 1048625:
    ...
    case 1179693:
    case 1179695:
      return parseUnaryExpression(e, t, a, r, s, i, p, l);
    case 1572868:
    case 1572866:
    ...
    case 34603028:
      return parseArrayLiteral(e, t, o ? 0 : 1, a, i, p, l);
    case 34603021:
      return parseObjectLiteral(e, t, o ? 0 : 1, a, i, p, l);
    case 1048588:
      return parseParenthesizedExpression(e, t, a, o, 1, 0, i, p, l);
    case 1048579:
      return parseBigIntLiteral(e, t);
    case 1179741:
...
function parseAsyncExpression(e, t, n, r, s, o, a, i) {
  ...
  return 0 === n && 1048588 === e.token
    ? parseAsyncArrowOrCallExpression(e, 8192 ^ (8192 | t), x, s, e.newLine, 1, 0, o, a, i)
    : 11 === e.token
    ? (1 === n && report(e, 74),
      3211376 === e.token && report(e, 37),
      2098176 & t && 3473517 === e.token && report(e, 36),
...
function parseAsyncArrowIdentifier(e, t, n, r, s, o, a, i, p, l) {
  return (
    (e.flags = (256 ^ (256 | e.flags)) | (537919488 == (537919488 & o) ? 32 : 0)),
    addBlockName(e, t, n, s, 1, 0),
    parseArrowFunction(e, t, n, [a], r, i, p, l)
  );
}
function parseAsyncArrowOrCallExpression(e, t, n, r, s, o, a, i, p, l) {
  nextToken(e, t, 1);
  ...
  if (17 === e.token)
    return (
      ...
      11 === e.token
        ...
        : 2 & t
        ? { type: 'CallExpression', callee: n, arguments: [], start: i, end: e.endIndex, loc: setLoc(e, p, l) }
  ...
  const x = [];
  for (; 17 !== e.token; ) {
    const { token: r, tokenValue: s, start: i, line: p, column: l } = e;
    if ((2555904 & r) > 0)
      addBlockName(e, t, c, s, 1, 0),
        (d = parsePrimaryExpression(e, t, o, 0, 1, 1, 1, i, p, l)),
        17 === e.token || 19 === e.token
          ? (u |= (0 === e.assignable ? 264 : 0) | ((538181632 & r) > 0 ? 256 : 0))
          : 67108896 === e.token
          ? ((u |= 256), (d = parseAssignmentExpression(e, t, 0, 1, d, i, p, l)))
          : ((u |= 8),
            (d = parseMemberExpression(e, t, d, 0, i, p, l)),
            (d = parseAssignmentExpression(e, t, 0, 1, d, i, p, l)));
    else if (33554432 & r)
      (d =
        34603021 === e.token
          ? parseObjectLiteralOrPattern(e, t, c, 0, 0, 1, o, a, i, p, l)
          : parseArrayExpressionOrPattern(e, t, c, 0, 0, 1, o, a, i, p, l)),
        (u |= 256 | e.flags),
        17 !== e.token &&
          19 !== e.token &&
          (16 & u && report(e, 64),
      ...
      if (15 !== r) {
        ...
        return (
          ...
          (e.assignable = 0),
          2 & t
            ? { type: 'CallExpression', callee: n, arguments: x, start: i, end: e.endIndex, loc: setLoc(e, p, l) }
            : { type: 'CallExpression', callee: n, arguments: x }
        );
      }
      (d = parseSpreadOrRestElement(e, t, c, 17, 0, 1, 1, o, a, i, p, l)),
  ...
  return (
    ...
    11 === e.token
      ...
      : (0 == (16 & t) && 512 & e.flags && report(e, 68),
...
function parseImportCallOrMetaExpression(e, t, n, r, s, o) {
  ...
  return 14 !== e.token
    ? (1 === n && report(e, 51),
      ...
      (e.assignable = 0),
      parseMemberExpression(e, t, i, 0, r, s, o))
...
function parseNewExpression(e, t, n, r, s, o) {
  ...
  return (
    (e.assignable = 0),
    2 & t
      ? { type: 'NewExpression', callee: l, arguments: c, start: r, end: e.endIndex, loc: setLoc(e, s, o) }
...
function parseNewMemberExpression(e, t, n, r, s, o, a) {
  switch (e.token) {
    case 14: {
      nextToken(e, t, 0), (e.assignable = 1);
      const i = parsePropertyOrPrivatePropertyName(e, t);
    ...
    case 1048585:
      return parseNewMemberExpression(
        ...
        t,
        n,
        parseTemplateExpression(e, t, r, parseTemplate(e, 65536 | t, s, o, a), s, o, a),
        s,
        o,
        a
      );
    case 1048586:
      return parseNewMemberExpression(
        ...
        t,
        n,
        parseTemplateExpression(e, t, r, parseTemplateLiteral(e, t), s, o, a),
        s,
        o,
        a
      );
...
function parseTemplateExpression(e, t, n, r, s, o, a) {
  return (
    (e.assignable = 0),
    2 & t
      ? { type: 'TaggedTemplateExpression', tag: n, quasi: r, start: s, end: e.endIndex, loc: setLoc(e, o, a) }
      : { type: 'TaggedTemplateExpression', tag: n, quasi: r }
  );
}
...
function parseBigIntLiteral(e, t) {
  const { start: n, line: r, column: s } = e,
    o = e.source.slice(n, e.index);
  return (
    nextToken(e, t, 0),
    (e.assignable = 0),
    2 & t
      ? { type: 'BigIntLiteral', value: null, bigint: o, start: n, end: e.endIndex, loc: setLoc(e, r, s) }
      : { type: 'BigIntLiteral', value: null, bigint: o }
  );
}
function parseArrowFunctionAfterParen(e, t, n, r, s, o, a, i, p, l) {
  12 & r && report(e, 71),
    2098176 & t && 1024 & r && report(e, 36),
    (e.flags = (3102 ^ (3102 | e.flags)) | r),
    0 === o && report(e, 73);
  let c = s.length;
  for (; c--; ) reinterpretToPattern(e, s[c]);
  return parseArrowFunction(e, t, n, s, a, i, p, l);
}
function parseArrowFunction(e, t, n, r, s, o, a, i) {
  ...
  else if (((l = parseFunctionBody(e, 276824064 ^ (276824064 | t), n, void 0, 1, void 0)), 0 === e.newLine)) {
    const { token: t } = e;
  ...
  return (
    ...
    2 & t
      ...
      : { type: 'ArrowFunctionExpression', body: l, params: r, async: 1 === s, expression: p }
  );
}
function parseParenthesizedExpression(e, t, n, r, s, o, a, i, p) {
  ...
  for (e.assignable = 1; 17 !== e.token; ) {
    ...
    if ((2555904 & r) > 0)
      addBlockName(e, t, k, y, 1, 0),
        ...
        19 === e.token || 17 === e.token
          ...
          : ((u |= 67108896 === e.token ? 256 : 8),
            (l = parseMemberExpression(e, t, l, n, a, i, p)),
            17 !== e.token && 19 !== e.token && (l = parseAssignmentExpression(e, t, 0, 1, l, a, i, p)));
    else {
      if (!(33554432 & r)) {
        if (15 === r) {
          (l = parseSpreadOrRestElement(e, t, k, 17, 0, 0, 1, s, o, a, i, p)),
      ...
      (l =
        34603021 === e.token
          ? parseObjectLiteralOrPattern(e, t, k, 0, 0, 1, s, o, a, i, p)
          : parseArrayExpressionOrPattern(e, t, k, 0, 0, 1, s, o, a, i, p)),
        (u |= 256 | e.flags),
        (e.assignable = 0),
        19 !== e.token &&
          17 !== e.token &&
          (16 & u && report(e, 64),
          (l = parseMemberExpression(e, t, l, 0, a, i, p)),
          (u |= 8),
          (67108864 & e.token) > 0
            ? (0 === e.assignable && report(e, 60),
  ...
  return (
    ...
    11 === e.token
      ...
      : (16 & u && report(e, 75),
        0 == (16 & t) && 512 & e.flags && report(e, 68),
        (e.flags = (30 ^ (30 | e.flags)) | u),
        0 == (128 & t)
          ? l
          : 2 & t
          ? { type: 'ParenthesizedExpression', expression: l, start: x, end: e.endIndex, loc: setLoc(e, m, f) }
...
function parseLeftHandSideExpression(e, t, n, r, s) {
  ...
  return parseMemberExpression(e, t, parsePrimaryExpression(e, t, 0, 0, r, s, n, o, a, i), n, o, a, i);
}
  ...
  return (
    ...
    0 === n
      ? 2 & t
        ...
        : { type: 'AssignmentExpression', left: s, operator: o, right: l }
      : 2 & t
      ? { type: 'AssignmentPattern', left: s, right: l, start: a, end: e.endIndex, loc: setLoc(e, i, p) }
      : { type: 'AssignmentPattern', left: s, right: l }
  );
}
function parseArrayExpressionOrPattern(e, t, n, r, s, o, a, i, p, l, c) {
  nextToken(e, t, 1);
  const d = [];
  let u = 0;
  for (t = 8192 ^ (8192 | t); 21 !== e.token; )
    if (consumeOpt(e, t, 19, 1)) d.push(null);
      ...
      if (
        ((2555904 & p) > 0
          ? ((r = parsePrimaryExpression(e, t, a, 0, 1, 1, o, l, c, x)),
            67108896 === e.token
              ? (0 === e.assignable && report(e, 60), (r = parseAssignmentOrPattern(e, t, s, o, r, '=', l, c, x)))
              : 19 === e.token || 21 === e.token
              ? 1 === e.assignable
                ? addVarOrBlock(e, t, n, m, a, i)
                : (u |= 8)
              : ((u |= 1 & a ? 4 : 8 != (8 & a) ? 8 : 0),
                (r = parseMemberExpression(e, t, r, 0, l, c, x)),
                (67108864 & e.token) > 0
                  ? (0 === e.assignable && report(e, 60),
                    (r = parseAssignmentOrPattern(e, t, s, 0, r, KeywordDescTable[255 & e.token], l, c, x)))
                  : (135266304 & e.token) > 0
                  ? ((u |= 8),
          ...
          ? ((r =
              34603021 === e.token
                ? parseObjectLiteralOrPattern(e, t, n, 0, s, 0, a, i, l, c, x)
                : parseArrayExpressionOrPattern(e, t, n, 0, s, 0, a, i, l, c, x)),
            (u |= e.flags),
            ...
            19 !== e.token && 21 !== e.token
              ...
              : (u |= 8 & u ? 8 : 0))
          : 15 === p
          ? ((r = parseSpreadOrRestElement(e, t, n, 21, s, 0, o, a, i, l, c, x)),
            19 !== e.token && 21 !== e.token && report(e, 86, KeywordDescTable[255 & e.token]),
            (u |= e.flags))
          : ((r = parseLeftHandSideExpression(e, t, 0, 1, 1)),
            19 !== e.token && 21 !== e.token
              ? ((r = parseAssignmentExpression(e, t, s, 0, r, l, c, x)), (u |= 0 == (9 & a) && 1048588 === p ? 8 : 0))
              : 0 === e.assignable
              ? (u |= 8)
  ...
  const x =
    2 & t
      ? { type: s ? 'ArrayPattern' : 'ArrayExpression', elements: d, start: p, end: e.endIndex, loc: setLoc(e, l, c) }
      : { type: s ? 'ArrayPattern' : 'ArrayExpression', elements: d };
  return 0 === r && 67108864 & e.token
    ? parseArrayOrObjectAssignmentPattern(e, t, u, s, o, p, l, c, x)
...
function parseArrayOrObjectAssignmentPattern(e, t, n, r, s, o, a, i, p) {
  ...
  const l = parseAssignmentOrPattern(e, t, r, s, p, '=', o, a, i);
...
function parseFunctionExpression(e, t, n, r, s, o) {
  ...
  if ((2555904 & e.token) > 0) {
    ...
    const { token: n, tokenValue: r, start: s, line: o, column: c } = e;
    validateFunctionName(e, (6291456 ^ (6291456 | t)) | a, n),
      (i = n),
      nextToken(e, t, 0),
      (p = parseIdentifierFromValue(e, t, r, s, o, c));
  }
...
function parseFunctionLiteral(e, t, n, r, s, o, a, i, p, l, c) {
  ...
  if (16777232 !== e.token) {
    for (; 1572868 === e.token; ) {
      ...
      isExactlyStrictDirective(e, n, r, a)
        ...
        : (d = 0),
        0 === d && (p = parseNonDirectiveExpression(e, t, p, r, s, o)),
        expectSemicolon(e, t),
        l.push(parseDirectives(e, t, i, a, p, r, s, o));
    }
    1024 & t &&
      (r && (537919488 == (537919488 & r) && report(e, 27), 262144 == (262144 & r) && report(e, 26)),
      o && 0 == (1024 & c) && 0 == (268435456 & t) && reportScopeError(o),
...
function parseClassExpression(e, t, n, r, s, o) {
  ...
  return parseClassTail(e, t, a, i, n, 0, 'ClassExpression', r, s, o);
}
function parseClassTail(e, t, n, r, s, o, a, i, p, l) {
  let c = null;
  131159 === e.token
    ? (nextToken(e, t, 1), (c = parseLeftHandSideExpression(e, t, s, 0, 0)), (n |= 524288))
    : (n = 524288 ^ (524288 | n));
...
function parseClassBody(e, t, n, r, s) {
  ...
  consume(e, t, 34603021, 1);
  const p = [];
  for (e.flags = 1 ^ (1 | e.flags); 16777234 === e.token; ) nextToken(e, t, 0);
  for (; 16777232 !== e.token; )
    for (p.push(parseClassElementList(e, t, n, 0, null, 0, s, 0, e.start, e.line, e.column)); 16777234 === e.token; )
      nextToken(e, t, 0);
  return (
...
function parseClassElementList(e, t, n, r, s, o, a, i, p, l, c) {
  const { token: d, start: u, line: x, column: m } = e;
  if ((2555904 & d) > 0) {
    if (((s = parseIdentifier(e, t)), 1048588 !== e.token))
      switch (d) {
        case 262252:
          if (0 == (32 & i)) return parseClassElementList(e, t, n, r, s, o, a, 32 | i, u, x, m);
          break;
        case 2162799:
    ...
    switch (d) {
      ...
      case 1572868:
        ...
        break;
      case 1048579:
        s = parseBigIntLiteral(e, t);
        break;
      case 34603028:
        (o = 1), (s = parseComputedPropertyName(e, n, a));
        break;
      case 135314230:
        (i |= 8), nextToken(e, t, 0);
        break;
  ...
  (408 & i) > 0 &&
    ((2555904 & e.token) > 0
      ...
      ? (s = parseLiteral(e, t))
      : 34603028 === e.token
      ? ((o = 1), (s = parseComputedPropertyName(e, t, 0)))
      : 1048579 === e.token
      ? (s = parseBigIntLiteral(e, t))
      : report(e, 52)),
    0 === o &&
  ...
  return 2 & t
    ...
    : { type: 'MethodDefinition', kind: k, static: (32 & i) > 0, computed: 1 === o, key: s, value: f };
}
...
function parseGetterSetter(e, t, n) {
  ...
  if (
      ...
      if (
        ((2555904 & e.token) > 0
          ? (1024 != (1024 & t) &&
            ...
            (r = parseAndClassifyIdentifier(e, t, i, d, u, 1, 0, p, l, c, 0)))
          : (34603028 === e.token
        ...
        67108896 === e.token && ((o = 1), (r = parseAssignmentOrPattern(e, t, 1, 0, r, '=', p, l, c))),
        s++,
        a.push(r),
        19 !== e.token)
      )
    ...
    256 & n && 1 !== s && report(e, 38, 'Setter', 'one', ''),
  ...
  return (
    ...
    2 & t
      ? {
          ...
          params: a,
          body: parseFunctionBody(e, t, i, void 0, 0, void 0),
          async: 1 == (16 & n),
          generator: 1 == (8 & n),
          id: null,
          start: r,
...
function parseFormalParams(e, t, n, r, s, o) {
  ...
  for (; 17 !== e.token; ) {
    ...
    if (
      ((2555904 & d) > 0
        ? (1024 != (1024 & t) &&
            (e.flags |= (262144 == (262144 & d) ? 64 : 0) | (537919488 == (537919488 & d) ? 32 : 0)),
          (o = parseAndClassifyIdentifier(e, t, n, d, u, 1 | r, 0, p, l, c, 0)))
        : ((i = 1),
          34603028 === e.token
            ? ((o = parseArrayExpressionOrPattern(e, t, n, 1, 1, 0, r, s, p, l, c)), (i = 1))
            : 34603021 === e.token
            ? ((o = parseObjectLiteralOrPattern(e, t, n, 1, 1, 0, r, s, p, l, c)), (i = 1))
            : 15 === e.token
            ? (o = parseSpreadOrRestElement(e, t, n, 17, 1, 0, 0, r, s, p, l, c))
            : report(e, 0),
          12 & e.flags && report(e, 70)),
      67108896 === e.token && ((i = 1), (o = parseAssignmentOrPattern(e, t, 1, 0, o, '=', p, l, c))),
      a.push(o),
      19 !== e.token)
    )
      break;
  ...
  return (
    void 0 !== n.scopeError && (1 === o || 1 === i || 1024 & t) && reportScopeError(n.scopeError),
    (e.flags |= 1 === i ? 256 : 0),
    consume(e, t, 17, 0),
    a
  );
...
function parseObjectLiteralOrPattern(e, t, n, r, s, o, a, i, p, l, c) {
  nextToken(e, t, 0);
  const d = [];
  t = 8192 ^ (8192 | t);
  let u,
  ...
  for (; 16777232 !== e.token; ) {
    ...
    if (15 === r) d.push(parseSpreadOrRestElement(e, t, n, 16777232, s, 0, o, a, i, p, l, c));
    else {
      if (((k = 0), (2555904 & r) > 0))
        if (
          (nextToken(e, t, 0),
          ...
          (k |= 4),
            ...
            67108896 === e.token
              ? ((x |= 16), (u = parseAssignmentOrPattern(e, t, s, o, f, '=', p, l, c)))
              : ((x |= 1 === o && 3211376 === r ? 2048 : 0), (u = f));
        else if (22 === e.token) {
          nextToken(e, t, 1);
          const { start: p, line: l, column: c } = e;
          if (('__proto__' === g && m++, (2555904 & e.token) > 0)) {
            const { token: r, tokenValue: d } = e;
            u = parsePrimaryExpression(e, t, a, 0, 1, 1, o, p, l, c);
            const { token: m } = e;
            (u = parseMemberExpression(e, t, u, 0, p, l, c)),
              19 === e.token || 16777232 === e.token
                ...
                ? (0 === e.assignable ? (x |= 8) : 67108896 !== m ? (x |= 4) : addVarOrBlock(e, t, n, d, a, i),
                  (u = parseAssignmentExpression(e, t, s, o, u, p, l, c)))
                : ((x |= 8),
            ...
            33554432 == (33554432 & e.token)
              ? ((u =
                  34603021 === e.token
                    ? parseObjectLiteralOrPattern(e, t, n, 0, s, 0, a, i, p, l, c)
                    : parseArrayExpressionOrPattern(e, t, n, 0, s, 0, a, i, p, l, c)),
                (x = e.flags),
                ...
                19 === e.token || 16777232 === e.token
                  ...
                  : ((u = parseMemberExpression(e, t, u, 0, p, l, c)),
                    ...
                    67108864 == (67108864 & e.token)
                      ? (u = parseAssignmentOrPattern(e, t, s, 0, u, KeywordDescTable[255 & e.token], p, l, c))
              ...
              : ((u = parseLeftHandSideExpression(e, t, 0, 1, 1)),
                ...
                19 === e.token || 16777232 === e.token
                  ...
                  : ((u = parseMemberExpression(e, t, u, 0, p, l, c)),
                    ...
                    19 !== e.token &&
                      16777232 !== r &&
                      (67108896 !== e.token && (x |= 8), (u = parseAssignmentExpression(e, t, s, 0, u, p, l, c)))));
        } else
          34603028 === e.token
            ? ((x |= 8),
              (k |= 2162799 === r ? 16 : 0),
            ...
            ? ((65650 !== r && 65651 !== r) || report(e, 91),
              ...
              (2555904 & e.token) > 0
                ...
                ? (f = parseLiteral(e, t))
                : 34603028 === e.token
                ? ((k |= 2), (f = parseComputedPropertyName(e, t, o)))
                : report(e, 0),
              (u = parseMethodDefinition(e, t, k)))
            : (524288 & e.token) > 0
            ? (2162799 === r && (k |= 16),
        ...
        if (((f = parseLiteral(e, t)), 22 === e.token)) {
          ...
          if (('__proto__' === g && m++, (2555904 & e.token) > 0)) {
            u = parsePrimaryExpression(e, t, a, 0, 1, 1, o, r, p, l);
            const { token: c, tokenValue: d } = e;
            (u = parseMemberExpression(e, t, u, 0, r, p, l)),
              19 === e.token || 16777232 === e.token
                ? 67108896 === c || 16777232 === c || 19 === c
                  ...
                  : (x |= 1 === e.assignable ? 4 : 8)
                : 67108896 === e.token
                ? ((x |= 0 === e.assignable ? 8 : 0), (u = parseAssignmentExpression(e, t, s, 0, u, r, p, l)))
                : ((x |= 8), (u = parseAssignmentExpression(e, t, s, 0, u, r, p, l)));
          } else
            (33554432 & e.token) > 0
              ? ((u =
                  34603021 === e.token
                    ? parseObjectLiteralOrPattern(e, t, n, 0, s, 0, a, i, r, p, l)
                    : parseArrayExpressionOrPattern(e, t, n, 0, s, o, a, i, r, p, l)),
                (x = e.flags),
                (e.assignable = 8 & x ? 0 : 1),
                19 === e.token || 16777232 === e.token
                  ? 0 === e.assignable && (x |= 8)
                  ...
                  : ((u = parseMemberExpression(e, t, u, 0, r, p, l)),
                    (x = 0 === e.assignable ? 8 : 0),
                    (67108864 & e.token) > 0
                      ? (u = parseAssignmentOrPattern(e, t, s, 0, u, KeywordDescTable[255 & e.token], r, p, l))
              ...
              : ((u = parseLeftHandSideExpression(e, t, 0, 1, 1)),
                ...
                19 === e.token || 16777232 === e.token
                  ...
                  : ((u = parseMemberExpression(e, t, u, 0, r, p, l)),
                    ...
                    19 !== e.token &&
                      16777232 !== e.token &&
                      (67108896 !== e.token && (x |= 8), (u = parseAssignmentExpression(e, t, s, 0, u, r, p, l)))));
        } else 1048588 === e.token ? ((k |= 1), (u = parseMethodDefinition(e, t, k)), (x |= 8)) : report(e, 0);
      else if (34603028 === e.token)
        if (((f = parseComputedPropertyName(e, t, o)), (k |= 2), 22 === e.token)) {
          nextToken(e, t, 1);
          ...
          if ((2555904 & e.token) > 0) {
            ...
            33554432 == (33554432 & e.token)
              ? ((u =
                  34603021 === e.token
                    ? parseObjectLiteralOrPattern(e, t, n, 0, s, 0, a, i, r, p, l)
                    : parseArrayExpressionOrPattern(e, t, n, 0, s, 0, a, i, r, p, l)),
                (x = e.flags),
                (e.assignable = 8 & x ? 0 : 1),
                19 === e.token || 16777232 === e.token
                  ? 0 === e.assignable && (x |= 8)
        ...
        consume(e, t, 135314230, 0),
          ...
          (2555904 & e.token) > 0
            ...
            : 1048579 === e.token
            ? ((f = parseBigIntLiteral(e, t)), (k |= 1), (u = parseMethodDefinition(e, t, k)), (x |= 8))
            : report(e, 99);
      else if (1048579 === e.token)
        if (((f = parseBigIntLiteral(e, t)), 22 === e.token)) {
          nextToken(e, t, 1);
          const { start: r, line: p, column: l } = e;
          if ((2555904 & e.token) > 0) {
            u = parsePrimaryExpression(e, t, a, 0, 1, 1, o, r, p, l);
      ...
      else report(e, 86, KeywordDescTable[255 & r]);
  ...
  return 67108864 == (67108864 & e.token) && 0 === r
    ? parseArrayOrObjectAssignmentPattern(e, t, x, s, o, p, l, c, g)
    : ((e.flags = (30 ^ (30 | e.flags)) | x | (m > 1 ? 512 : 0)), g);
}
function parseSpreadOrRestElement(e, t, n, r, s, o, a, i, p, l, c, d) {
  let u;
  nextToken(e, t, 1);
  let x = 0;
  ...
  if ((2555904 & y) > 0) {
    ...
    (u = parseMemberExpression(e, t, u, 0, m, f, k)),
      19 !== e.token &&
        e.token !== r &&
        (0 === e.assignable && 67108896 === e.token && report(e, 56),
        (x |= 8),
        (u = parseAssignmentExpression(e, t, s, 0, u, m, f, k))),
    ...
    if ((y === r && report(e, 0), !(33554432 & y))) {
      ...
      return (
        67108896 === n && n !== r && 19 !== n
          ? (0 === e.assignable && report(e, 60), (u = parseAssignmentExpression(e, t, s, 0, u, m, f, k)), (x |= 8))
          : (19 === n ? (x |= 8) : n !== r && (u = parseAssignmentExpression(e, t, 0, 0, u, m, f, k)),
            (x |= 1 === e.assignable ? 4 : 8)),
        (e.flags = (30 ^ (30 | e.flags)) | x),
        e.token !== r && 19 !== e.token && report(e, 61),
        2 & t
          ? { type: s ? 'RestElement' : 'SpreadElement', argument: u, start: l, end: e.endIndex, loc: setLoc(e, c, d) }
    ...
    }
    {
      ...
      67108896 !== o && o !== r && 19 !== o
        ? (16 & e.flags && report(e, 56),
          ...
          (x |= 0 === e.assignable ? 8 : 0),
          67108864 == (67108864 & e.token)
            ? (67108896 !== e.token && (x |= 8), (u = parseAssignmentExpression(e, t, s, 0, u, m, f, k)))
  ...
  return (
    e.token !== r &&
      (1 & i && (x |= o ? 8 : 4),
      67108896 === e.token
        ? (8 & x && report(e, 60), (u = parseAssignmentOrPattern(e, t, s, 0, u, '=', l, c, d)), (x = 8))
        : (x |= 8)),
    (e.flags = (30 ^ (30 | e.flags)) | x),
    2 & t
      ? { type: s ? 'RestElement' : 'SpreadElement', argument: u, start: l, end: e.endIndex, loc: setLoc(e, c, d) }
...
function parseAndClassifyIdentifier(e, t, n, r, s, o, a, i, p, l, c = 0) {
  return (
    ...
    3473483 === r && 48 & o && report(e, 29),
    4196352 & t && 3211376 === r && report(e, 30),
    nextToken(e, t, c),
    addVarOrBlock(e, t, n, s, o, a),
    2 & t
      ? { type: 'Identifier', name: s, start: i, end: e.endIndex, loc: setLoc(e, p, l) }
      : { type: 'Identifier', name: s }
  );
}
function parseBindingPattern(e, t, n, r, s) {
  const { tokenValue: o, start: a, line: i, column: p, token: l } = e;
  if ((2555904 & l) > 0) return parseAndClassifyIdentifier(e, t, n, l, o, r, s, a, i, p, 1);
...
function parseDirectives(e, t, n, r, s, o, a, i) {
  return 32 & t
    ? 2 & t
      ? {
      ...
      : { type: 'ExpressionStatement', expression: s, directive: n ? e.source.slice(e.start, e.index) : r }
    : 2 & t
    ? { type: 'ExpressionStatement', expression: s, start: o, end: e.endIndex, loc: setLoc(e, a, i) }
    : { type: 'ExpressionStatement', expression: s };
}
function parseNonDirectiveExpression(e, t, n, r, s, o) {
  return (
    (n = parseAssignmentExpression(e, t, 0, 0, (n = parseMemberExpression(e, t, n, 0, r, s, o)), r, s, o)),
...
function parseFunctionDeclarationRest(e, t, n, r, s, o, a, i) {
  nextToken(e, t, 1);
  const p = 2 & r && consumeOpt(e, t, 135314230, 0),
    l = 4 & r ? 1 : 0;
  let c,
    d = null,
  ...
  if (1048588 === e.token) 8 & r && report(e, 32, 'Function');
    ...
    const { token: o, tokenValue: a, start: i, line: p, column: l } = e;
    validateFunctionName(e, t | ((3072 & t) << 11), o),
      (4 & s) > 0 && 0 == (2048 & t) ? addVarName(e, t, n, a, 2) : addBlockName(e, t, n, a, 4, s),
      (16 & r) > 0 && declareUnboundVariable(e, a),
...
function parseClassDeclaration(e, t, n, r) {
  ...
  let p = null;
  if (2555904 & e.token && 131159 !== e.token) {
    const { token: s, start: o, line: a, column: i, tokenValue: l } = e;
    isStrictReservedWord(e, t, s, 0) && report(e, 26),
      addBlockName(e, t, n, l, 64, 0),
      2 & r && declareUnboundVariable(e, l),
      nextToken(e, t, 0),
      (p = parseIdentifierFromValue(e, t, l, o, a, i));
  } else 0 == (1 & r) && report(e, 32, 'Class');
  return parseClassTail(e, t, i, p, 0, 1, 'ClassDeclaration', s, o, a);
}
  ...
  for (; 19 !== e.token; ) {
    ...
    if (
      ...
      67108896 === e.token
        ...
        : 0 != (1056 & a) && 4194304 != (4194304 & e.token) && report(e, 34, 32 & r ? 'const' : 'destructuring'),
      o.push(
        2 & t
...
function parseImportCallDeclaration(e, t, n, r, s) {
  ...
  return (o = parseMemberExpression(e, t, o, 0, n, r, s)), parseExpressionStatement(e, t, o, n, r, s);
}
function parseImportMetaDeclaration(e, t, n, r, s) {
  ...
  return (
    ...
    (o = parseMemberExpression(e, t, o, 0, n, r, s)),
    (o = parseAssignmentExpression(e, t, 0, 0, o, n, r, s)),
...
function parseStatementList(e, t, n) {
  ...
  let s = 0;
  for (; 1572868 === e.token; ) {
    const { index: n, start: o, line: a, column: i, tokenValue: p, isUnicodeEscape: l } = e;
    let c = parseLiteral(e, t);
    isExactlyStrictDirective(e, n, o, p) ? ((s = 1), (t |= 1024)) : (s = 0),
      0 === s && (c = parseNonDirectiveExpression(e, t, c, o, a, i)),
      expectSemicolon(e, t),
      r.push(parseDirectives(e, t, l, p, c, o, a, i));
  }
...
function parseLabelledStatement(e, t, n, r, s, o, a, i, p, l, c, d, u) {
  ...
  const x =
    0 === l || (1040 & t) > 0 || 1179738 !== e.token
      ? parseStatement(e, t, n, r, s, o, l)
...
function parseAsyncArrowOrAsyncFunctionDeclaration(e, t, n, r, s, o) {
  ...
  if ((nextToken(e, t, 0), 22 === e.token))
    return parseLabelledStatement(e, t, n, r, s, null, i, a, parseIdentifierFromValue(e, t, i, p, l, c), o, p, l, c);
  const d = e.newLine;
  if (0 === d) {
    if (1179738 === e.token) return 0 === o && report(e, 79), parseFunctionDeclarationRest(e, t, n, 15, r, p, l, c);
...
function parseForStatementWithVariableDeclarations(e, t, n, r, s, o, a, i) {
  const { token: p, start: l, line: c, column: d, tokenValue: u } = e;
  let x,
    m = null,
    f = null,
    k = null;
  ...
  if (
    ...
    3473483 === p
      ? 0 != (36110336 & e.token)
        ? (139624500 === e.token
            ? (1024 & t && report(e, 40), (k = parseIdentifierFromValue(e, t, u, l, c, d)))
            : (y = 16),
          (e.assignable = 1))
        : (1024 & t && report(e, 40),
          (k = parseIdentifierFromValue(e, t, u, l, c, d)),
          (e.assignable = 1),
          (k = parseMemberExpression(e, t, k, 0, l, c, d)),
          (g = !0))
      : ((e.assignable = 1), (y = 1179722 === p ? 2 : 32)),
    (50 & y) > 0)
  ) {
    const r = [];
    let s,
    ...
    for (; 19 !== e.token; ) {
      ...
      let d;
      s = y | (33554432 == (33554432 & e.token) ? 1024 : 0);
      let u = null;
      if (
        (0 != (2555904 & c)
          ? ((d = parseAndClassifyIdentifier(e, t, n, c, a, y, 32, i, p, l, 1)),
            67108896 === e.token
              ? (nextToken(e, t, 1),
                (u = parseExpression(e, 8192 | t, 0)),
                4194304 == (4194304 & e.token) &&
                  (4259957 === e.token && report(e, 33, 'of'),
                  ((139624500 === e.token && 2 != (2 & y)) || (1040 & t) > 0) && report(e, 33, 'in')))
              : 0 != (1056 & s) && 4194304 != (4194304 & e.token) && report(e, 34, 32 & y ? 'const' : 'destructuring'))
          : 33554432 == (33554432 & c) &&
            ((d =
              34603028 === e.token
                ? parseArrayExpressionOrPattern(e, 8192 | t, n, 1, 1, 0, y, 32, i, p, l)
                : parseObjectLiteralOrPattern(e, 8192 | t, n, 1, 1, 0, y, 32, i, p, l)),
            (12 & e.flags) > 0 && report(e, 70),
            67108896 === e.token
              ? (nextToken(e, t, 1),
                (u = parseExpression(e, 8192 | t, 0)),
                4194304 == (4194304 & e.token) &&
    ...
    o > 1 && 4194304 == (4194304 & e.token) && report(e, 35),
      (k =
        2 & t
          ? {
              type: 'VariableDeclaration',
          ...
          : { type: 'VariableDeclaration', kind: y, declarations: r });
  }
  if (4259957 === e.token) {
    g && report(e, 41),
      0 === e.assignable && report(e, 69, 'of'),
      nextToken(e, t, 1),
      (x = parseExpression(e, t, 0)),
      consume(e, t, 17, 1);
    const r = parseStatement(e, 131072 | t, n, 32, s, null, 0);
    return 2 & t
      ? {
          type: 'ForOfStatement',
          body: r,
      ...
      : { type: 'ForOfStatement', body: r, left: k, right: x, await: !1 };
  }
  if (139624500 === e.token) {
    0 === e.assignable && report(e, 69, 'in'),
      1 === r && report(e, 0),
      nextToken(e, t, 1),
      (x = parseExpressions(e, t, 0)),
      consume(e, t, 17, 1);
    const p = parseStatement(e, 131072 | t, n, 32, s, null, 0);
    return 2 & t
      ? { type: 'ForInStatement', body: p, left: k, right: x, start: o, end: e.endIndex, loc: setLoc(e, a, i) }
      : { type: 'ForInStatement', body: p, left: k, right: x };
  }
  (k = parseAssignmentExpression(e, t, 0, 0, k, l, c, d)),
    19 === e.token && (k = parseSequenceExpression(e, t, k, e.start, e.line, e.column)),
    consume(e, t, 16777234, 1),
    16777234 !== e.token && (m = parseExpressions(e, t, 0)),
    consume(e, t, 16777234, 1),
    17 !== e.token && (f = parseExpressions(e, t, 0)),
    consume(e, t, 17, 1);
  const b = parseStatement(e, 131072 | t, n, 32, s, null, 0);
  return 2 & t
    ? { type: 'ForStatement', body: b, init: k, test: m, update: f, start: o, end: e.endIndex, loc: setLoc(e, a, i) }
    : { type: 'ForStatement', body: b, init: k, test: m, update: f };
}
function parseForStatement(e, t, n, r) {
  ...
  if (1179722 === x || 3473483 === x || 1179724 === x)
    return parseForStatementWithVariableDeclarations(e, t, n, i, r, s, o, a);
  if (
    (33554432 == (33554432 & x)
      ? ((d =
          34603021 === x
        ...
        (d = parseMemberExpression(e, t, d, 0, e.start, e.line, e.column)),
        (u = e.flags))
      : 16777234 === x
      ? 1 === i && report(e, 0)
  ...
  if (139624500 === e.token) {
    ...
    const l = parseStatement(e, 131072 | t, n, 32, r, null, 0);
    return 2 & t
      ? { type: 'ForInStatement', body: l, left: d, right: p, start: s, end: e.endIndex, loc: setLoc(e, o, a) }
  ...
  return 2 & t
    ? { type: 'ForStatement', body: y, init: d, test: l, update: c, start: s, end: e.endIndex, loc: setLoc(e, o, a) }
...
function parseDoWhileStatement(e, t, n, r, s) {
  ...
  return (
    ...
    2 & t
      ? { type: 'DoWhileStatement', body: p, start: o, test: l, end: e.endIndex, loc: setLoc(e, a, i) }
...
function parseWhileStatement(e, t, n, r, s) {
  ...
  consume(e, t, 17, 1);
  const l = parseStatement(e, 131072 | t, n, 0, r, s, 0);
  return 2 & t
    ? { type: 'WhileStatement', test: p, body: l, start: o, end: e.endIndex, loc: setLoc(e, a, i) }
...
function parseSwitchStatement(e, t, n, r, s) {
  ...
  for (n = { parent: n, type: 0, scopeError: void 0 }; 16777232 !== e.token; ) {
    ...
    for (
      ...
      p.push(parseStatementListItem(e, 134217728 | t, n, 2, r, s));
    l.push(
      2 & t
        ? { type: 'SwitchCase', test: d, consequent: p, start: o, end: e.endIndex, loc: setLoc(e, a, i) }
  ...
  return (
    consume(e, t, 16777232, 1),
    2 & t
      ? { type: 'SwitchStatement', discriminant: p, cases: l, start: o, end: e.endIndex, loc: setLoc(e, a, i) }
...
function parseIfStatement(e, t, n, r) {
  ...
  return 2 & t
    ? { type: 'IfStatement', test: i, consequent: p, alternate: l, start: s, end: e.endIndex, loc: setLoc(e, o, a) }
...
function parseTryStatement(e, t, n, r) {
  ...
  if (131151 === e.token) {
    ...
    p =
      2 & t
        ? { type: 'CatchClause', param: i, body: c, start: s, end: e.endIndex, loc: setLoc(e, o, a) }
  ...
  return (
    p || l || report(e, 42),
    2 & t
      ? { type: 'TryStatement', block: i, handler: p, finalizer: l, start: s, end: e.endIndex, loc: setLoc(e, o, a) }
...
function parseWithStatement(e, t, n, r, s) {
  ...
  const p = parseExpressions(e, t, 0);
  consume(e, t, 17, 1);
  const l = parseStatement(e, t, n, 0, r, s, 0);
  return 2 & t
    ? { type: 'WithStatement', object: p, body: l, start: o, end: e.endIndex, loc: setLoc(e, a, i) }
...
function parseLetIdentOrVarDeclarationStatement(e, t, n, r, s, o) {
  const { token: a, tokenValue: i, start: p, line: l, column: c } = e;
  if ((nextToken(e, t, 0), (36110336 & e.token) > 0)) {
  ...
  return 22 === e.token
    ? parseLabelledStatement(e, t, n, o, r, s, i, a, d, 0, p, l, c)
    : (11 === e.token
        ...
        : ((d = parseMemberExpression(e, t, d, 0, p, l, c)), (d = parseAssignmentExpression(e, t, 0, 0, d, p, l, c))),
...
function parseExpressionOrLabelledStatement(e, t, n, r, s, o, a) {
  ...
  return (
    ...
    22 === e.token
      ? parseLabelledStatement(e, t, n, r, s, o, i, p, u, a, l, c, d)
      : ((u = parseMemberExpression(e, t, u, 0, l, c, d)),
        (u = parseAssignmentExpression(e, t, 0, 0, u, l, c, d)),
        parseExpressionStatement(e, t, 19 === e.token ? parseSequenceExpression(e, t, u, l, c, d) : u, l, c, d))
  );
}
function parseModuleItemListAndDirectives(e, t, n) {
  ...
  if (32 & t)
    for (; 1572868 === e.token; ) {
      ...
      let p = parseLiteral(e, t);
      16777234 !== e.token && (p = parseNonDirectiveExpression(e, t, p, n, s, o)), expectSemicolon(e, t);
...
function parseImportDeclaration(e, t, n) {
  ...
  if (1572868 === e.token)
    return (
      ...
      expectSemicolon(e, t),
      2 & t
        ? { type: 'ImportDeclaration', specifiers: i, source: a, start: r, end: e.endIndex, loc: setLoc(e, s, o) }
  ...
  switch (e.token) {
    ...
    case 34603021:
      for (nextToken(e, t, 0); (2555904 & e.token) > 0; ) {
        let { start: r, line: s, column: o, tokenValue: a, token: p } = e;
        nextToken(e, t, 0);
        const l = parseIdentifierFromValue(e, t, a, r, s, o);
        let c;
        65646 === e.token
          ? (nextToken(e, t, 0),
          ...
          i.push(
            2 & t
              ? { type: 'ImportSpecifier', local: c, imported: l, start: r, end: e.endIndex, loc: setLoc(e, s, o) }
      ...
      break;
    case 1048588:
      return parseImportCallDeclaration(e, t, r, s, o);
    case 14:
      return parseImportMetaDeclaration(e, t, r, s, o);
    default:
      report(e, 0);
  }
  return (
...
function parseExportDefault(e, t, n, r, s, o) {
  nextToken(e, t, 1);
  let a = null;
  switch (e.token) {
    case 1179738:
    ...
    case 2162799:
      ...
      nextToken(e, t, 0),
        0 === e.newLine &&
          (1179738 === e.token
            ? (a = parseFunctionDeclarationRest(e, t, n, 7, 64, s, o, i))
            : (2162688 & e.token) > 0
            ...
            : ((a = parseIdentifierFromValue(e, t, r, s, o, i)),
              ...
              (a = parseMemberExpression(e, t, a, 0, s, o, i)),
              (a = parseAssignmentExpression(e, t, 0, 0, a, s, o, i))));
      break;
    default:
...
function parseExportDeclaration(e, t, n) {
  ...
  switch (e.token) {
    case 131155:
      return parseExportDefault(e, t, n, r, s, o);
    case 135314230:
    ...
    case 34603021: {
      ...
      for (; (2555904 & e.token) > 0; ) {
        ...
        (i = d),
          nextToken(e, t, 0),
          (s = parseIdentifierFromValue(e, t, d, p, l, c)),
          65646 === e.token
            ? (nextToken(e, t, 0),
          ...
          a.push(
            2 & t
              ? { type: 'ExportSpecifier', local: s, exported: o, start: p, end: e.endIndex, loc: setLoc(e, l, c) }
              : { type: 'ExportSpecifier', local: s, exported: o }
          ),
          16777232 !== e.token && consume(e, t, 19, 0);
      }
    ...
    case 2162799: {
      ...
      if ((nextToken(e, t, 0), 0 === e.newLine && 1179738 === e.token)) {
        i = parseFunctionDeclarationRest(e, t, n, 15, 64, r, s, o);
        break;
      }
    }
    default:
...
function parseScript(e, t) {
  ...
  const r = create(e);
  skipHashBang(r, e), nextToken(r, 512 | n, 1);
...
function parseModule(e, t) {
  ...
  const r = create(e);
  skipHashBang(r, e), nextToken(r, 512 | n, 1);
  const s = { parent: void 0, type: 2 },
    o = parseModuleItemListAndDirectives(r, 268435456 | n, s);
  for (const e in r.exportedBindings) '#' !== e[0] || s[e] || report(r, 103, e.slice(1));
  return 2 & n
    ? {
        type: 'Program',
        sourceType: 'module',
    ...
    : { type: 'Program', sourceType: 'module', body: o };
}
(exports.parseModule = parseModule), (exports.parseScript = parseScript);
