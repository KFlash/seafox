...
function skipMultiLineComment(e, t, n) {
  ...
  for (; n < e.length; ) {
    if (o < 43) {
      ...
      13 === o && (e.lineBase++, (r = 1), (e.newLine = 1), (e.offset = n)),
...
function scanIdentifierOrKeyword(e, t, n, r) {
  for (; 5 & CharTypes[r]; ) r = n.charCodeAt(++e.index);
  const o = n.slice(e.start, e.index);
  return r > 90 ? scanIdentifierSlowPath(e, t, n, o, 1) : descKeywordTable[(e.tokenValue = o)] || 3211265;
}
function scanIdentifierSlowPath(e, t, n, r, o) {
  ...
  const c = (r += n.slice(s, e.index)).length;
  if (((e.tokenValue = r), o && c >= 2 && c <= 11)) {
  ...
  if (123 === r) {
    ...
    for (; o >= 0; )
      o < 0 && report(e, 17),
        ...
        (o = toHex((r = t.charCodeAt(++e.index))));
    ...
    case 117: {
      ...
      if (123 === o) {
        ...
        for (; r >= 0; ) {
          ...
          r = toHex((o = n.charCodeAt(++e.index)));
        }
...
function scanRegularExpression(e, t, n, r) {
  ...
  for (; isIdentifierPart(c); ) {
    switch (c) {
      case 103:
        2 & i && report(e, 14, 'g'), (i |= 2);
        break;
      case 105:
        1 & i && report(e, 14, 'i'), (i |= 1);
        break;
      case 109:
        4 & i && report(e, 14, 'm'), (i |= 4);
        break;
      case 117:
        16 & i && report(e, 14, 'g'), (i |= 16);
        break;
      case 121:
        8 & i && report(e, 14, 'y'), (i |= 8);
        break;
      case 115:
        12 & i && report(e, 14, 's'), (i |= 12);
        break;
      default:
        report(e, 13);
    }
  ...
  const l = n.slice(p, r),
    d = n.slice(o, a);
  return (
    (e.tokenRegExp = { pattern: d, flags: l }),
    (e.index = r),
    8 & t && (e.tokenRaw = n.slice(e.start, r)),
    (e.tokenValue = validate(e, d, l)),
    1048581
  );
}
...
function scan(e, t, n, r, o, s, a, i, p) {
  let c;
  for (; e.index < o; ) {
    if (((c = n.charCodeAt(e.index)), (e.line = e.lineBase), (e.column = (e.start = e.index) - e.offset), c > 126)) {
      if (8232 == (-2 & c)) {
        (e.offset = ++e.index), (e.newLine = 1), e.lineBase++, (a = 0);
        continue;
      }
      if (1 & (unicodeLookup[104448 + (c >>> 5)] >>> c)) {
        e.index++;
        continue;
      }
      return scanMaybeIdentifier(e, t, n, c);
    }
    switch ((s = firstCharKinds[c])) {
      case 16777232:
      case 34603021:
      case 19:
      case 22:
      ...
      case 123:
        ...
        break;
      case 3211265:
        return scanIdentifier(e, t, n, c);
      case 132:
        return scanIdentifierOrKeyword(e, t, n, c);
      case 1572866:
        return scanNumber(e, n, c, 0);
      case 1572868:
        return scanStringLiteral(e, t, n, c);
      case 1048586:
      ...
      case 125:
        if (e.index + 1 < o)
          switch (((c = n.charCodeAt(++e.index)), CharKinds[c])) {
            case 129:
            ...
            case 1572866:
            case 131:
              return scanImplicitOctalDigits(e, t, n, c);
          }
        return scanNumber(e, n, c, 0);
      case 122:
      ...
      case 14:
        return (
          (c = n.charCodeAt(++e.index)),
          c >= 48 && c <= 57
            ? scanNumberAfterDecimalPoint(e, n, c)
            : 46 === c && 46 === n.charCodeAt(e.index + 1)
            ? ((e.index += 2), 15)
            : 14
        );
      case 135314232:
        if (((r = ++e.index), (c = n.charCodeAt(r)), 47 === c)) {
          r++, (e.index = skipSingleLineComment(e, n, r));
          continue;
        }
        if (42 === c) {
          r++, (e.index = skipMultiLineComment(e, n, r));
          continue;
        }
        return 1 === p ? scanRegularExpression(e, t, n, r) : 61 === c ? (e.index++, 68157480) : 135314232;
      case 67108896:
        return (
          (c = n.charCodeAt(++e.index)),
          61 === c
      ...
      case 23:
        return (
          (c = n.charCodeAt(++e.index)),
          46 === c
            ? ((c = n.charCodeAt(e.index + 1)), c >= 48 && c <= 57 ? 23 : (e.index++, 25))
            : 63 === c
            ? (e.index++, 1209012504)
            : 23
        );
      case 135301186:
        if (((c = n.charCodeAt(++e.index)), 60 === c))
          return 61 === n.charCodeAt(++e.index) ? (e.index++, 67108897) : 135305540;
        if (61 === c) return (e.index += 1), 135296832;
        if (33 === c && e.index < o && 45 === n.charCodeAt(e.index + 2) && 45 === n.charCodeAt(e.index + 1)) {
          e.index = skipSingleHTMLComment(e, t, n, e.index + 1);
          continue;
        }
        return 135301186;
      case 135309875:
        if (((c = n.charCodeAt(++e.index)), 45 === c)) {
...
function recordScopeError(e, t, ...n) {
  const { index: r, line: o, column: s } = e;
  return { type: t, params: n, index: r, line: o, column: s };
}
function addVarOrBlock(e, t, n, r, o, s) {
  2 & o ? addVarName(e, t, n, r, o) : addBlockName(e, t, n, r, o, s);
}
function addBlockName(e, t, n, r, o, s) {
  ...
  a &&
    8 != (8 & a) &&
    (1 & o ? (n.scopeError = recordScopeError(e, 22, r)) : (16 != (16 & t) && 4 & a && 2 & s) || report(e, 22, r)),
    128 & n.type && n.parent['#' + r] && 8 != (8 & n.parent['#' + r]) && report(e, 22, r),
    1024 & n.type && a && 8 != (8 & a) && 1 == (1 & o) && (n.scopeError = recordScopeError(e, 22, r)),
...
function addVarName(e, t, n, r, o) {
  ...
  for (; s && 0 == (256 & s.type); ) {
    const a = s['#' + r];
    244 & a && ((16 != (16 & t) && 0 == (1024 & t) && ((128 & o && 6 & a) || (128 & a && 6 & o))) || report(e, 22, r)),
      s === n && 1 & a && 1 & o && (s.scopeError = recordScopeError(e, 22, r)),
...
function validateFunctionName(e, t, n) {
  1024 & t && (262144 == (262144 & n) && report(e, 26), 537919488 == (537919488 & n) && report(e, 26)),
...
function parseAssignmentExpression(e, t, n, r, o, s, a, i) {
  ...
  return (
    135266304 == (135266304 & p) && (o = parseBinaryExpression(e, t, r, 4, p, s, a, i, o)),
...
function parseBinaryExpression(e, t, n, r, o, s, a, i, p) {
  let c, l, d, u;
  const m = 8192 & t ? 3840 : 61440;
  for (; (135266304 & o) > 0; ) {
    if (((c = e.token), (c & m) + ((135318585 === c) << 8) <= r)) return p;
    ((8388608 & o) | (1073741824 & c) | (8388608 & c) | (1073741824 & o)) > 1073741824 && report(e, 45),
      nextToken(e, t, 1),
      ...
      (p =
        2 & t
          ? { type: l, left: p, right: d, operator: u, start: s, end: e.endIndex, loc: setLoc(e, a, i) }
...
function parseMemberExpression(e, t, n, r, o, s, a, i, p) {
  ...
  switch (e.token) {
    ...
    case 34603028: {
      nextToken(e, t, 1);
      const c = parseExpressions(e, 8192 ^ (8192 | t), s);
      return (
        consume(e, t, 21, 0),
        (e.assignable = 1),
      ...
      return (
        ...
        parseMemberExpression(
          ...
          2 & t
            ...
            : { type: 'CallExpression', callee: n, arguments: c, optional: 1 === r, shortCircuited: 1 === o },
          0,
          r,
          s,
          a,
...
function parseYieldExpression(e, t, n, r, o, s, a) {
  if ((1 === n && (e.flags |= 1024), 2097152 & t)) {
    ...
    return (
      0 === e.newLine &&
        ((i = consumeOpt(e, t, 135314230, 1)), (1048576 & e.token || i) && (n = parseExpression(e, t, 0))),
      (e.assignable = 0),
      2 & t
        ? { type: 'YieldExpression', argument: n, delegate: i, start: o, end: e.endIndex, loc: setLoc(e, s, a) }
...
function parsePrimaryExpression(e, t, n, r, o, s, a, i, p, c) {
  const l = e.token;
  if (2162688 == (2162688 & l)) {
    if (3473517 === l) return parseYieldExpression(e, t, a, s, i, p, c);
    if (3211376 === l) return parseAwaitExpression(e, t, a, r, i, p, c);
    if (2162799 === l) return parseAsyncExpression(e, t, r, o, s, i, p, c);
    3473483 === l && (1024 & t && report(e, 94), 48 & n && report(e, 29));
    ...
    return 11 === e.token
      ? (0 === o && report(e, 0),
        0 === s && report(e, 73),
        r && report(e, 74),
        1024 & t && 537919488 == (537919488 & l) && report(e, 27),
        isValidIdentifier(t, l) || report(e, 0),
      ...
      : ((e.assignable = 1024 & t && 537919488 == (537919488 & l) ? 0 : 1), u);
  }
  if (269484032 == (269484032 & l)) return parseUpdateExpressionPrefix(e, t, r, o, i, p, c);
  switch (l) {
    case 1179694:
    case 1048624:
    case 1048625:
    ...
    case 1179693:
    case 1179695:
      return parseUnaryExpression(e, t, a, r, o, i, p, c);
    case 1572868:
    case 1572866:
    ...
    case 34603028:
      return parseArrayLiteral(e, t, s ? 0 : 1, a, i, p, c);
    case 34603021:
      return parseObjectLiteral(e, t, s ? 0 : 1, a, i, p, c);
    case 1048588:
      return parseParenthesizedExpression(e, t, a, s, 1, 0, i, p, c);
    case 1572867:
...
function parseAsyncExpression(e, t, n, r, o, s, a, i) {
  const { token: p, tokenValue: c, start: l, line: d, column: u } = e;
  ...
  const m = parseIdentifierFromValue(e, t, c, l, d, u);
  return 0 === n && 1048588 === e.token
    ? parseAsyncArrowOrCallExpression(e, 8192 ^ (8192 | t), m, o, e.newLine, 1, 0, s, a, i)
    : 11 === e.token
    ? (1 === n && report(e, 74),
      3211376 === e.token && report(e, 37),
      2098176 & t && 3473517 === e.token && report(e, 36),
...
function parseAsyncArrowIdentifier(e, t, n, r, o, s, a, i, p, c) {
  return (
    (e.flags = (256 ^ (256 | e.flags)) | (537919488 == (537919488 & s) ? 32 : 0)),
    addBlockName(e, t, n, o, 1, 0),
    parseArrowFunction(e, t, n, [a], r, i, p, c)
  );
}
function parseAsyncArrowOrCallExpression(e, t, n, r, o, s, a, i, p, c) {
  nextToken(e, t, 1);
  ...
  const m = [];
  for (; 17 !== e.token; ) {
    const { token: r, tokenValue: o, start: i, line: p, column: c } = e;
    if (2555904 & r)
      addBlockName(e, t, l, e.tokenValue, 1, 0),
        (d = parsePrimaryExpression(e, t, s, 0, 1, 1, 1, i, p, c)),
        17 === e.token || 19 === e.token
          ? (u |= (0 === e.assignable ? 264 : 0) | (0 != (538181632 & r) ? 256 : 0))
          : 67108896 === e.token
          ? ((u |= 256), (d = parseAssignmentExpression(e, t, 0, 1, d, i, p, c)))
          : ((u |= 8),
            (d = parseMemberExpression(e, t, d, 0, 0, 0, i, p, c)),
            (d = parseAssignmentExpression(e, t, 0, 1, d, i, p, c)));
    else if (33554432 & r)
      (d =
        34603021 === e.token
          ? parseObjectLiteralOrPattern(e, t, l, 0, 0, 1, s, a, i, p, c)
          : parseArrayExpressionOrPattern(e, t, l, 0, 0, 1, s, a, i, p, c)),
        (u |= 256 | e.flags),
        17 !== e.token &&
          19 !== e.token &&
          (16 & u && report(e, 64),
      ...
      if (15 !== r) {
        for (d = parseExpression(e, t, 0), m.push(d); consumeOpt(e, t, 19, 1); ) m.push(parseExpression(e, t, 0));
        return (
          consume(e, t, 17, 0),
          ...
          2 & t
            ...
            : { type: 'CallExpression', callee: n, arguments: m, optional: !1, shortCircuited: !1 }
        );
      }
      (d = parseSpreadOrRestElement(e, t, l, 17, 0, 1, 1, s, a, i, p, c)),
        (u |= 256 | (17 === e.token ? 0 : 8) | e.flags);
    }
    if ((m.push(d), 19 !== e.token)) break;
    nextToken(e, t, 1);
  }
  return (
    consume(e, t, 17, 0),
    ...
    11 === e.token
      ? (2048 & e.flags && report(e, 37), parseArrowFunctionAfterParen(e, t, l, u, m, r, 1, i, p, c))
...
function parseNewExpression(e, t, n, r, o, s) {
  ...
  const { start: a, line: i, column: p } = e,
    c = parseNewMemberExpression(e, t, n, parsePrimaryExpression(e, t, 0, 1, 1, 0, n, a, i, p), a, i, p),
    l = 1048588 === e.token ? parseArguments(e, t, n) : [];
  return (
    (e.assignable = 0),
    2 & t
      ? { type: 'NewExpression', callee: c, arguments: l, start: r, end: e.endIndex, loc: setLoc(e, o, s) }
...
function parseArrowFunctionAfterParen(e, t, n, r, o, s, a, i, p, c) {
  12 & r && report(e, 71),
    2098176 & t && 1024 & r && report(e, 36),
    (e.flags = (3102 ^ (3102 | e.flags)) | r),
    0 === s && report(e, 73);
  let l = o.length;
  for (; l--; ) reinterpretToPattern(e, o[l]);
  return parseArrowFunction(e, t, n, o, a, i, p, c);
}
function parseArrowFunction(e, t, n, r, o, s, a, i) {
  ...
  else if (269484032 == (269484032 & e.token)) report(e, 96);
  else
    switch (e.token) {
      case 14:
      case 34603028:
  ...
  return (
    ...
    2 & t
      ...
      : { type: 'ArrowFunctionExpression', body: c, params: r, async: 1 === o, expression: p }
  );
}
    ...
    if (2555904 & r)
      ...
      if (!(33554432 & r)) {
        ...
        if (
          ...
          l =
            2 & t
              ? { type: 'SequenceExpression', expressions: d, start: x, end: e.endIndex, loc: setLoc(e, f, k) }
              : { type: 'SequenceExpression', expressions: d };
        }
        return consume(e, t, 17, 0), (e.flags = (30 ^ (30 | e.flags)) | m), l;
      }
      (l =
        34603021 === e.token
          ? parseObjectLiteralOrPattern(e, t, c, 0, 0, 1, o, s, a, i, p)
          : parseArrayExpressionOrPattern(e, t, c, 0, 0, 1, o, s, a, i, p)),
        (m |= 256 | e.flags),
        (e.assignable = 0),
        19 !== e.token &&
          17 !== e.token &&
          ...
          (m |= 8),
          19 !== e.token && 17 !== e.token && (l = parseAssignmentExpression(e, t, 0, 0, l, a, i, p)));
    }
    ...
    u &&
      ...
      (l =
        2 & t
          ...
          : { type: 'SequenceExpression', expressions: d })),
    consume(e, t, 17, 0),
    8 & m && 16 & m && report(e, 62),
    (m |= (1024 & e.flags ? 1024 : 0) | (2048 & e.flags ? 2048 : 0)),
    11 === e.token
      ? (4196352 & t && 2048 & m && report(e, 37), parseArrowFunctionAfterParen(e, t, c, m, u ? d : [l], r, 0, a, i, p))
      : (16 & m && report(e, 75), (e.flags = (30 ^ (30 | e.flags)) | m), l)
  );
}
  ...
  return (
    ...
    0 === n
      ? 2 & t
        ...
        : { type: 'AssignmentExpression', left: o, operator: s, right: c }
      : 2 & t
      ? { type: 'AssignmentPattern', left: o, right: c, start: a, end: e.endIndex, loc: setLoc(e, i, p) }
      : { type: 'AssignmentPattern', left: o, right: c }
  );
}
function parseArrayExpressionOrPattern(e, t, n, r, o, s, a, i, p, c, l) {
  nextToken(e, t, 1);
  const d = [];
  let u = 0;
  for (t = 8192 ^ (8192 | t); 21 !== e.token; )
    if (consumeOpt(e, t, 19, 1)) d.push(null);
      ...
      let r;
      const { token: p, start: c, line: l, column: m, tokenValue: x } = e;
      if (
        (2555904 & p
          ? ((r = parsePrimaryExpression(e, t, a, 0, 1, 1, s, c, l, m)),
            67108896 === e.token
              ? (0 === e.assignable && report(e, 60),
                addVarOrBlock(e, t, n, x, a, i),
                (r = parseAssignmentOrPattern(e, t, o, s, r, '=', c, l, m)))
              : 19 === e.token || 21 === e.token
              ? 0 === e.assignable
                ? (u |= 8)
                : addVarOrBlock(e, t, n, x, a, i)
              : ((u |= 1 & a ? 4 : 8 != (8 & a) ? 8 : 0),
                (r = parseMemberExpression(e, t, r, 0, 0, 0, c, l, m)),
                19 !== e.token && 21 !== e.token
                  ? (67108896 !== e.token && (u |= 8), (r = parseAssignmentExpression(e, t, o, 0, r, c, l, m)))
                  : 67108896 !== e.token && (u |= 0 === e.assignable ? 8 : 4)))
          : 33554432 & p
          ? ((r =
              34603021 === e.token
                ? parseObjectLiteralOrPattern(e, t, n, 0, o, 0, a, i, c, l, m)
                : parseArrayExpressionOrPattern(e, t, n, 0, o, 0, a, i, c, l, m)),
            ...
            19 === e.token || 21 === e.token
              ...
              : (16 & e.flags && report(e, 56),
                ...
                19 !== e.token && 21 !== e.token
                  ? (r = parseAssignmentExpression(e, t, o, 0, r, c, l, m))
                  : 67108896 !== e.token && (u |= 0 === e.assignable ? 8 : 4)))
          : 15 === p
          ? ((r = parseSpreadOrRestElement(e, t, n, 21, o, 0, s, a, i, c, l, m)),
            (u |= e.flags),
            19 !== e.token && 21 !== e.token && report(e, 86, KeywordDescTable[255 & e.token]))
          : ((r = parseLeftHandSideExpression(e, t, 0, 1, 1)),
            19 !== e.token && 21 !== e.token
              ? ((r = parseAssignmentExpression(e, t, o, 0, r, c, l, m)), 0 == (9 & a) && 1048588 === p && (u |= 8))
              : 0 === e.assignable
              ? (u |= 8)
  ...
  consume(e, t, 21, 0);
  const m = o ? 'ArrayPattern' : 'ArrayExpression',
    x = 2 & t ? { type: m, elements: d, start: p, end: e.endIndex, loc: setLoc(e, c, l) } : { type: m, elements: d };
  return 0 === r && 67108864 & e.token
    ? parseArrayOrObjectAssignmentPattern(e, t, u, o, s, p, c, l, x)
...
function parseArrayOrObjectAssignmentPattern(e, t, n, r, o, s, a, i, p) {
  ...
  const c = parseAssignmentOrPattern(e, t, r, o, p, '=', s, a, i);
...
function parseFunctionLiteral(e, t, n, r, o, s, a, i, p, c, l) {
  ...
  if (16777232 !== e.token) {
    for (; 1572868 === e.token; ) {
      ...
      isExactlyStrictDirective(e, n, r, a)
        ...
        consumeSemicolon(e, t),
        c.push(parseDirectives(e, t, i, a, p, r, o, s));
    }
    1024 & t &&
      (r && (537919488 == (537919488 & r) && report(e, 27), 262144 == (262144 & r) && report(e, 26)),
      s && 0 == (1024 & l) && 0 == (268435456 & t) && reportScopeError(s),
...
function parseClassDeclarationOrExpressionRest(e, t, n, r, o, s, a, i, p, c) {
  let l = null;
  131159 === e.token
    ? (nextToken(e, t, 1), (l = parseLeftHandSideExpression(e, t, o, 0, 0)), (n |= 524288))
    : (n = 524288 ^ (524288 | n));
...
function parseClassBody(e, t, n, r, o) {
  ...
  for (e.flags = 1 ^ (1 | e.flags); 16777232 !== e.token; )
    16777234 !== e.token
      ? p.push(parseClassElementList(e, t, n, 0, null, 0, 0, o, 0, e.start, e.line, e.column))
      : nextToken(e, t, 0);
  return (
...
function parseClassElementList(e, t, n, r, o, s, a, i, p, c, l, d) {
  const { token: u, start: m, line: x, column: f } = e;
  if (2555904 & u) {
    if (((o = parseIdentifier(e, t)), 1048588 !== e.token))
      switch (u) {
        case 262252:
          if (0 === s) return parseClassElementList(e, t, n, r, o, 1, a, i, p, m, x, f);
          break;
        case 2162799:
          p |= 16 | (optionalBit(e, t, 135314230) ? 8 : 0);
          break;
        case 65650:
          p |= 128;
          break;
    ...
    524288 == (524288 & u)
      ? (o = parseLiteral(e, t))
      : 34603028 === u
      ? ((a = 1), (o = parseComputedPropertyName(e, n, i)))
      : 135314230 === u
      ? ((p |= 8), nextToken(e, t, 0))
      : report(e, 86, KeywordDescTable[255 & e.token]);
  408 & p &&
    (2555904 & e.token
      ...
      ? (o = parseLiteral(e, t))
      : 34603028 === e.token
      ? ((a = 1), (o = parseComputedPropertyName(e, t, 0)))
      : report(e, 52)),
    0 === a &&
      ('constructor' === e.tokenValue
        ? (0 === s &&
            1048588 === e.token &&
            (408 & p && report(e, 53, 'accessor'),
            524288 != (524288 & t) && (1 & e.flags ? report(e, 54) : (e.flags |= 1))),
          (p |= 64))
        : 440 & p && 'prototype' === e.tokenValue && report(e, 55)),
    (r = 64 | e.flags);
  const k = 256 & p ? parseGetterSetter(e, 1024 | t, p) : parseMethodDefinition(e, 1024 | t, p);
  e.flags = 96 ^ (96 | r);
  const y = 0 === s && 64 & p ? 'constructor' : 128 & p ? 'get' : 256 & p ? 'set' : 'method';
  return 2 & t
    ? {
    ...
    : { type: 'MethodDefinition', kind: y, static: 1 === s, computed: 1 === a, key: o, value: k };
}
      ...
      if (
        (2555904 & e.token
          ? (1024 != (1024 & t) &&
            ...
            (o = parseAndClassifyIdentifier(e, t, i, d, u, 1 | n, 0, r, c, l, 0)))
          : (34603028 === e.token
              ? (o = parseArrayExpressionOrPattern(e, t, i, 1, 1, 0, 1, 0, r, c, l))
              : 34603021 === e.token
              ? (o = parseObjectLiteralOrPattern(e, t, i, 1, 1, 0, 1, 0, r, c, l))
              : 15 === e.token
              ? (256 & n && report(e, 39), (o = parseSpreadOrRestElement(e, t, i, 17, 1, 0, 0, 1, 0, r, c, l)))
              : report(e, 0),
            (p = 1),
            12 & e.flags && report(e, 70)),
        67108896 === e.token && ((p = 1), (o = parseAssignmentOrPattern(e, t, 1, 0, o, '=', r, c, l))),
        s++,
        a.push(o),
        19 !== e.token)
      )
...
function parseFormalParams(e, t, n, r, o, s) {
  ...
  for (; 17 !== e.token; ) {
    let s;
    const { start: p, line: c, column: l, token: d, tokenValue: u } = e;
    if (
      (2555904 & d
        ? (1024 != (1024 & t) &&
            (e.flags |= (262144 == (262144 & d) ? 64 : 0) | (537919488 == (537919488 & d) ? 32 : 0)),
          (s = parseAndClassifyIdentifier(e, t, n, d, u, 1 | r, 0, p, c, l, 0)))
        : ((i = 1),
          34603028 === e.token
            ? ((s = parseArrayExpressionOrPattern(e, t, n, 1, 1, 0, r, o, p, c, l)), (i = 1))
            : 34603021 === e.token
            ? ((s = parseObjectLiteralOrPattern(e, t, n, 1, 1, 0, r, o, p, c, l)), (i = 1))
            : 15 === e.token
            ? (s = parseSpreadOrRestElement(e, t, n, 17, 1, 0, 0, r, o, p, c, l))
            : report(e, 0),
          12 & e.flags && report(e, 70)),
      67108896 === e.token && ((i = 1), (s = parseAssignmentOrPattern(e, t, 1, 0, s, '=', p, c, l))),
      a.push(s),
      19 !== e.token)
    )
      break;
...
function parseObjectLiteralOrPattern(e, t, n, r, o, s, a, i, p, c, l) {
  nextToken(e, t, 0);
  const d = [];
  t = 8192 ^ (8192 | t);
  let u,
  ...
  for (; 16777232 !== e.token; ) {
    const { token: r, start: p, line: c, column: l, tokenValue: b } = e;
    if (15 === r) d.push(parseSpreadOrRestElement(e, t, n, 16777232, o, 0, s, a, i, p, c, l));
    else {
      if (((y = 0), 2555904 & r))
        if (((k = parseIdentifier(e, t)), 19 === e.token || 16777232 === e.token || 67108896 === e.token))
          (y |= 4),
            ...
            addVarOrBlock(e, t, n, b, a, i),
            67108896 === e.token
              ? ((x |= 16), (u = parseAssignmentOrPattern(e, t, o, s, k, '=', p, c, l)))
              : (1 === s && 3211376 === r && (x |= 2048), (u = k));
        else if (22 === e.token) {
          nextToken(e, t, 1);
          const { start: p, line: c, column: l } = e;
          if (('__proto__' === b && f++, 2555904 & e.token)) {
            const { token: r, tokenValue: d } = e;
            u = parsePrimaryExpression(e, t, a, 0, 1, 1, s, p, c, l);
            const { token: m } = e;
            (u = parseMemberExpression(e, t, u, 0, 0, 0, p, c, l)),
              19 === e.token || 16777232 === e.token
                ...
                ? (0 === e.assignable ? (x |= 8) : 67108896 !== m ? (x |= 4) : addVarOrBlock(e, t, n, d, a, i),
                  (u = parseAssignmentExpression(e, t, o, s, u, p, c, l)))
                : ((x |= 8),
            ...
            33554432 == (33554432 & e.token)
              ? ((u =
                  34603021 === e.token
                    ? parseObjectLiteralOrPattern(e, t, n, 0, o, 0, a, i, p, c, l)
                    : parseArrayExpressionOrPattern(e, t, n, 0, o, 0, a, i, p, c, l)),
                (x = e.flags),
                ...
                19 === e.token || 16777232 === e.token
                  ...
                  : ((u = parseMemberExpression(e, t, u, 0, 0, 0, p, c, l)),
                    ...
                    67108864 == (67108864 & e.token)
                      ? ((m = KeywordDescTable[255 & e.token]),
                        (u = parseAssignmentOrPattern(e, t, o, 0, u, m, p, c, l)))
              ...
              : ((u = parseLeftHandSideExpression(e, t, 0, 1, 1)),
                ...
                19 === e.token || 16777232 === e.token
                  ...
                  : ((u = parseMemberExpression(e, t, u, 0, 0, 0, p, c, l)),
                    ...
                    19 !== e.token &&
                      16777232 !== r &&
                      (67108896 !== e.token && (x |= 8), (u = parseAssignmentExpression(e, t, o, 0, u, p, c, l)))));
        } else
          34603028 === e.token
            ? ((x |= 8),
              2162799 === r && (y |= 16),
            ...
            : 1048588 === e.token
            ? ((x |= 8), (y |= 1), (u = parseMethodDefinition(e, t, y)))
            : 135314230 === e.token
            ? ((65650 !== r && 65651 !== r) || report(e, 91),
              ...
              2555904 & e.token
                ...
                ? (k = parseLiteral(e, t))
                : 34603028 === e.token
                ? ((y |= 2), (k = parseComputedPropertyName(e, t, s)))
                : report(e, 0),
              (u = parseMethodDefinition(e, t, y)))
            : 524288 == (524288 & e.token)
            ? (2162799 === r && (y |= 16),
        ...
        if (((k = parseLiteral(e, t)), 22 === e.token)) {
          ...
          if (('__proto__' === b && f++, 2162688 & e.token)) {
            u = parsePrimaryExpression(e, t, a, 0, 1, 1, s, r, p, c);
            ...
            (u = parseMemberExpression(e, t, u, 0, 0, 0, r, p, c)),
              19 === e.token || 16777232 === e.token
                ? 67108896 === l || 16777232 === l || 19 === l
                  ...
                  : (x |= 1 === e.assignable ? 4 : 8)
                : 67108896 === e.token
                ? (0 === e.assignable && (x |= 8), (u = parseAssignmentExpression(e, t, o, 0, u, r, p, c)))
                : ((x |= 8), (u = parseAssignmentExpression(e, t, o, 0, u, r, p, c)));
          } else
            33554432 == (33554432 & e.token)
              ? ((u =
                  34603021 === e.token
                    ? parseObjectLiteralOrPattern(e, t, n, 0, o, 0, a, i, r, p, c)
                    : parseArrayExpressionOrPattern(e, t, n, 0, o, s, a, i, r, p, c)),
                (x = e.flags),
                (e.assignable = 8 & x ? 0 : 1),
                19 === e.token || 16777232 === e.token
                  ? 0 === e.assignable && (x |= 8)
                  ...
                  : ((u = parseMemberExpression(e, t, u, 0, 0, 0, r, p, c)),
                    ...
                    67108864 == (67108864 & e.token)
                      ? ((m = KeywordDescTable[255 & e.token]),
                        (u = parseAssignmentOrPattern(e, t, o, 0, u, m, r, p, c)))
                      : (135266304 == (135266304 & e.token) &&
              ...
              : ((u = parseLeftHandSideExpression(e, t, 0, 1, 1)),
                ...
                19 === e.token || 16777232 === e.token
                  ...
                  : ((u = parseMemberExpression(e, t, u, 0, 0, 0, r, p, c)),
                    ...
                    19 !== e.token &&
                      16777232 !== e.token &&
                      (67108896 !== e.token && (x |= 8), (u = parseAssignmentExpression(e, t, o, 0, u, r, p, c)))));
        } else 1048588 === e.token ? ((y |= 1), (u = parseMethodDefinition(e, t, y)), (x |= 8)) : report(e, 0);
      else if (34603028 === e.token)
        if (((k = parseComputedPropertyName(e, t, s)), (y |= 2), 22 === e.token)) {
          nextToken(e, t, 1);
          ...
          if (2555904 & e.token) {
            ...
            (u = parseMemberExpression(e, t, u, 0, 0, 0, r, p, c)),
              67108864 == (67108864 & e.token)
                ? ((x |= 0 === e.assignable ? 8 : 67108896 === f ? 0 : 4),
                  (m = KeywordDescTable[255 & e.token]),
                  (u = parseAssignmentOrPattern(e, t, o, 0, u, m, r, p, c)))
                : 19 === e.token || 16777232 === e.token
            ...
            33554432 == (33554432 & e.token)
              ? ((u =
                  34603021 === e.token
                    ? parseObjectLiteralOrPattern(e, t, n, 0, o, 0, a, i, r, p, c)
                    : parseArrayExpressionOrPattern(e, t, n, 0, o, 0, a, i, r, p, c)),
                (x = e.flags),
                (e.assignable = 8 & x ? 0 : 1),
                19 === e.token || 16777232 === e.token
                  ? 0 === e.assignable && (x |= 8)
          ...
          1048588 === e.token
            ? ((y |= 1), (x |= 2048 & e.flags ? 2048 : 0), (u = parseMethodDefinition(e, t, y)), (x |= 8))
            : report(e, 59);
      else
        135314230 === r
          ? (consume(e, t, 135314230, 0),
            ...
            2555904 & e.token
              ? ((k = parseIdentifier(e, t)),
                (y |= 1),
                1048588 === e.token ? ((x |= 8), (u = parseMethodDefinition(e, t, y))) : report(e, 0))
              : 524288 == (524288 & e.token)
              ? ((k = parseLiteral(e, t)), (y |= 1), (u = parseMethodDefinition(e, t, y)), (x |= 8))
              : 34603028 === e.token
              ? ((y |= 3), (k = parseComputedPropertyName(e, t, 0)), (u = parseMethodDefinition(e, t, y)), (x |= 8))
              : report(e, 99))
  ...
  consume(e, t, 16777232, 0), f > 1 && (x |= 512);
  const b =
    2 & t
      ? {
  ...
  return 67108864 == (67108864 & e.token) && 0 === r
    ? parseArrayOrObjectAssignmentPattern(e, t, x, o, s, p, c, l, b)
    : ((e.flags = (30 ^ (30 | e.flags)) | x), b);
}
function parseSpreadOrRestElement(e, t, n, r, o, s, a, i, p, c, l, d) {
  let u;
  nextToken(e, t, 1);
  let m = 0;
  const { start: x, line: f, column: k, token: y, tokenValue: g } = e;
  if (2555904 & y) {
    (e.assignable = 1), (u = parsePrimaryExpression(e, t, i, 0, 1, 1, a, x, f, k));
    const s = e.token === r || 19 === e.token;
    (u = parseMemberExpression(e, t, u, 0, 0, 0, x, f, k)),
      19 !== e.token &&
        e.token !== r &&
        (0 === e.assignable && 67108896 === e.token && report(e, 56),
        (m |= 8),
        (u = parseAssignmentExpression(e, t, o, 0, u, x, f, k))),
      0 === e.assignable ? (m |= 8) : s ? addVarOrBlock(e, t, n, g, i, p) : (m |= 4);
  } else {
    if ((y === r && report(e, 0), !(33554432 & y))) {
      (m |= 4), (u = parseLeftHandSideExpression(e, t, 0, 1, 1));
      const n = e.token;
      return (
        67108896 === n && n !== r && 19 !== n
          ? (0 === e.assignable && report(e, 60), (u = parseAssignmentExpression(e, t, o, 0, u, x, f, k)), (m |= 8))
          : (19 === n ? (m |= 8) : n !== r && (u = parseAssignmentExpression(e, t, 0, 0, u, x, f, k)),
            (m |= 1 === e.assignable ? 4 : 8)),
        (e.flags = (30 ^ (30 | e.flags)) | m),
        e.token !== r && 19 !== e.token && report(e, 61),
        2 & t
          ? { type: o ? 'RestElement' : 'SpreadElement', argument: u, start: c, end: e.endIndex, loc: setLoc(e, l, d) }
    ...
    }
    {
      u =
        34603021 === e.token
          ? parseObjectLiteralOrPattern(e, t, n, 1, o, 0, i, p, x, f, k)
          : parseArrayExpressionOrPattern(e, t, n, 1, o, 0, i, p, x, f, k);
      const s = e.token;
      67108896 !== s && s !== r && 19 !== s
        ? (16 & e.flags && report(e, 56),
          (u = parseMemberExpression(e, t, u, 0, 0, 0, x, f, k)),
          ...
          67108864 == (67108864 & e.token)
            ? (67108896 !== e.token && (m |= 8), (u = parseAssignmentExpression(e, t, o, 0, u, x, f, k)))
            : (135266304 == (135266304 & e.token) && (u = parseBinaryExpression(e, t, 0, 0, e.token, x, f, k, u)),
              23 === e.token && (u = parseConditionalExpression(e, t, u, x, f, k)),
              (m |= 0 === e.assignable ? 8 : 4)))
        : (m |= 16777232 === r && 67108896 !== s ? 8 : e.flags);
    }
  }
  return (
    e.token !== r &&
      (1 & i && (m |= s ? 8 : 4),
      67108896 === e.token
        ? (8 & m && report(e, 60), (u = parseAssignmentOrPattern(e, t, o, 0, u, '=', c, l, d)), (m = 8))
        : (m |= 8)),
    (e.flags = (30 ^ (30 | e.flags)) | m),
    2 & t
      ? { type: o ? 'RestElement' : 'SpreadElement', argument: u, start: c, end: e.endIndex, loc: setLoc(e, l, d) }
...
function parseAndClassifyIdentifier(e, t, n, r, o, s, a, i, p, c, l = 0) {
  return (
    ...
    2 & t
      ? { type: 'Identifier', name: o, start: i, end: e.endIndex, loc: setLoc(e, p, c) }
      : { type: 'Identifier', name: o }
  );
}
function parseBindingPattern(e, t, n, r, o) {
  const { tokenValue: s, start: a, line: i, column: p, token: c } = e;
  if (0 != (2555904 & c)) return parseAndClassifyIdentifier(e, t, n, c, s, r, o, a, i, p, 1);
...
function parseFunctionDeclarationRest(e, t, n, r, o, s, a, i) {
  ...
  if (1048588 === e.token) 8 & r && report(e, 32, 'Function');
    ...
    const { token: r, tokenValue: s, start: a, line: i, column: p } = e;
    validateFunctionName(e, t | ((3072 & t) << 11), r),
      4 & o && 2048 != (2048 & t) ? addVarName(e, t, n, s, 2) : addBlockName(e, t, n, s, 4, o),
      (u = { parent: u, type: 256, scopeError: void 0 }),
      (l = r),
      nextToken(e, t, 0),
      (d = parseIdentifierFromValue(e, t, s, a, i, p));
  }
  return parseFunctionLiteral(
    e,
...
function parseClassDeclaration(e, t, n, r) {
  ...
  return (
    ...
    parseClassDeclarationOrExpressionRest(e, t, i, p, 0, 1, 'ClassDeclaration', o, s, a)
  );
}
...
function parseStatementList(e, t, n) {
  ...
  let o = 0;
  for (; 1572868 === e.token; ) {
    const { index: n, start: s, line: a, column: i, tokenValue: p, isUnicodeEscape: c } = e;
    let l = parseLiteral(e, t);
    isExactlyStrictDirective(e, n, s, p) ? ((o = 1), (t |= 1024)) : (o = 0),
      0 === o && (l = parseNonDirectiveExpression(e, t, l, s, a, i)),
      consumeSemicolon(e, t),
      r.push(parseDirectives(e, t, c, p, l, s, a, i));
  }
...
function parseLabelledStatement(e, t, n, r, o, s, a, i, p, c, l, d, u) {
  ...
  const m =
    1040 & t || 1179738 !== e.token ? parseStatement(e, t, n, r, o, s, c) : parseFunctionDeclaration(e, t, n, 1, r);
  return 2 & t
    ? { type: 'LabeledStatement', label: p, body: m, start: l, end: e.endIndex, loc: setLoc(e, d, u) }
    : { type: 'LabeledStatement', label: p, body: m };
}
...
function parseAsyncArrowOrAsyncFunctionDeclaration(e, t, n, r, o, s) {
  ...
  if ((nextToken(e, t, 0), 22 === e.token))
    return parseLabelledStatement(e, t, n, r, o, null, i, a, parseIdentifierFromValue(e, t, i, p, c, l), s, p, c, l);
  const d = e.newLine;
  if (0 === d) {
    if (1179738 === e.token) return 0 === s && report(e, 79), parseFunctionDeclarationRest(e, t, n, 15, r, p, c, l);
    if (2162688 == (2162688 & e.token)) {
      2098176 & t && 3473517 === e.token && report(e, 36),
  ...
  return (
    ...
    (u = parseAssignmentExpression(e, t, 0, 0, u, p, c, l)),
    (e.assignable = 1),
...
function parseForStatementWithVariableDeclarations(e, t, n, r, o, s, a, i) {
  const { token: p, start: c, line: l, column: d, tokenValue: u } = e;
  let m,
    x = null,
    f = null,
    k = null;
  ...
  if (
    ...
    3473483 === p
      ? 0 != (36110336 & e.token)
        ? (139624500 === e.token
            ? (1024 & t && report(e, 40), (k = parseIdentifierFromValue(e, t, u, c, l, d)))
            : (y = 16),
          (e.assignable = 1))
        : (1024 & t && report(e, 40),
          (k = parseIdentifierFromValue(e, t, u, c, l, d)),
          (e.assignable = 1),
          (k = parseMemberExpression(e, t, k, 0, 0, 0, c, l, d)),
          (g = !0))
    ...
    for (; 19 !== e.token; ) {
      ...
      let d;
      o = y | (33554432 == (33554432 & e.token) ? 1024 : 0);
      let u = null;
      if (
        (0 != (2555904 & l)
          ? ((d = parseAndClassifyIdentifier(e, t, n, l, a, y, 32, i, p, c, 1)),
            67108896 === e.token
              ? (nextToken(e, t, 1),
                (u = parseExpression(e, 8192 | t, 0)),
                4194304 == (4194304 & e.token) &&
                  (4259957 === e.token && report(e, 33, 'of'),
                  ((139624500 === e.token && 2 != (2 & y)) || 1040 & t) && report(e, 33, 'in')))
              : 0 != (1056 & o) && 4194304 != (4194304 & e.token) && report(e, 34, 32 & y ? 'const' : 'destructuring'))
          : 33554432 == (33554432 & l) &&
            ((d =
              34603028 === e.token
                ? parseArrayExpressionOrPattern(e, 8192 | t, n, 1, 1, 0, y, 32, i, p, c)
                : parseObjectLiteralOrPattern(e, 8192 | t, n, 1, 1, 0, y, 32, i, p, c)),
            12 & e.flags && report(e, 70),
            67108896 === e.token
              ? (nextToken(e, t, 1),
                (u = parseExpression(e, 8192 | t, 0)),
  ...
  if (4259957 === e.token) {
    g && report(e, 41),
      ...
      nextToken(e, t, 1),
      (m = parseExpression(e, t, 0)),
      consume(e, t, 17, 1);
    const r = parseStatement(e, 131072 | t, n, 32, o, null, 0);
    return 2 & t
      ? {
          type: 'ForOfStatement',
          body: r,
      ...
      : { type: 'ForOfStatement', body: r, left: k, right: m, await: !1 };
  }
  if (139624500 === e.token) {
    0 === e.assignable && report(e, 69, 'in'),
      nextToken(e, t, 1),
      (m = parseExpressions(e, t, 0)),
      consume(e, t, 17, 1);
    const r = parseStatement(e, 131072 | t, n, 32, o, null, 0);
    return 2 & t
      ? { type: 'ForInStatement', body: r, left: k, right: m, start: s, end: e.endIndex, loc: setLoc(e, a, i) }
      : { type: 'ForInStatement', body: r, left: k, right: m };
  }
  (k = parseAssignmentExpression(e, t, 0, 0, k, c, l, d)),
    ...
    consume(e, t, 17, 1);
  const b = parseStatement(e, 131072 | t, n, 32, o, null, 0);
  return 2 & t
    ? { type: 'ForStatement', body: b, init: k, test: x, update: f, start: s, end: e.endIndex, loc: setLoc(e, a, i) }
    : { type: 'ForStatement', body: b, init: k, test: x, update: f };
}
function parseForStatement(e, t, n, r) {
  ...
  let p,
    ...
    d = null,
    u = 0;
  const { token: m, start: x, line: f, column: k } = e;
  if (1179722 === m || 3473483 === m || 1179724 === m)
    return parseForStatementWithVariableDeclarations(e, t, n, i, r, o, s, a);
  if (
    (33554432 == (33554432 & m)
      ? ((d =
          34603021 === m
            ? parseObjectLiteralOrPattern(e, t, n, 1, 0, 0, 8, 32, x, f, k)
            : parseArrayExpressionOrPattern(e, t, n, 1, 0, 0, 8, 32, x, f, k)),
        (u = e.flags),
  ...
  if (139624500 === e.token) {
    ...
    const c = parseStatement(e, 131072 | t, n, 32, r, null, 0);
    return 2 & t
      ? { type: 'ForInStatement', body: c, left: d, right: p, start: o, end: e.endIndex, loc: setLoc(e, s, a) }
      : { type: 'ForInStatement', body: c, left: d, right: p };
  }
  i && report(e, 0),
    67108896 === e.token
      ? (33554432 == (33554432 & m) && reinterpretToPattern(e, d),
        (d = parseAssignmentExpression(e, t, 0, 0, d, x, f, k)))
      : (16 == (16 & u) && report(e, 69, 'loop'), (d = parseAssignmentExpression(e, t, 0, 0, d, x, f, k))),
  ...
  return 2 & t
    ? { type: 'ForStatement', body: y, init: d, test: c, update: l, start: o, end: e.endIndex, loc: setLoc(e, s, a) }
...
function parseDoWhileStatement(e, t, n, r, o) {
  ...
  return (
    ...
    2 & t
      ? { type: 'DoWhileStatement', body: p, start: s, test: c, end: e.endIndex, loc: setLoc(e, a, i) }
...
function parseWhileStatement(e, t, n, r, o) {
  ...
  consume(e, t, 17, 1);
  const c = parseStatement(e, 131072 | t, n, 0, r, o, 0);
  return 2 & t
    ? { type: 'WhileStatement', test: p, body: c, start: s, end: e.endIndex, loc: setLoc(e, a, i) }
...
function parseSwitchStatement(e, t, n, r, o) {
  ...
  for (n = { parent: n, type: 8, scopeError: void 0 }; 16777232 !== e.token; ) {
    ...
    for (
      131155 === e.token && (nextToken(e, t, 1), l && report(e, 101), (l = 1)), consume(e, t, 22, 1);
  ...
  return (
    consume(e, t, 16777232, 1),
    2 & t
      ? { type: 'SwitchStatement', discriminant: p, cases: c, start: s, end: e.endIndex, loc: setLoc(e, a, i) }
...
function parseIfStatement(e, t, n, r) {
  ...
  return 2 & t
    ? { type: 'IfStatement', test: i, consequent: p, alternate: c, start: o, end: e.endIndex, loc: setLoc(e, s, a) }
...
function parseTryStatement(e, t, n, r) {
  ...
  if (131151 === e.token) {
    ...
    p =
      2 & t
        ? { type: 'CatchClause', param: i, body: l, start: o, end: e.endIndex, loc: setLoc(e, s, a) }
  ...
  return (
    p || c || report(e, 42),
    2 & t
      ? { type: 'TryStatement', block: i, handler: p, finalizer: c, start: o, end: e.endIndex, loc: setLoc(e, s, a) }
...
function parseWithStatement(e, t, n, r, o) {
  ...
  const p = parseExpressions(e, t, 0);
  consume(e, t, 17, 1);
  const c = parseStatement(e, t, n, 0, r, o, 0);
  return 2 & t
    ? { type: 'WithStatement', object: p, body: c, start: s, end: e.endIndex, loc: setLoc(e, a, i) }
...
function parseLetIdentOrVarDeclarationStatement(e, t, n, r, o, s) {
  ...
  return 22 === e.token
    ? parseLabelledStatement(e, t, n, s, r, o, i, a, d, 0, p, c, l)
    : (11 === e.token
        ...
        : ((d = parseMemberExpression(e, t, d, 0, 0, 0, p, c, l)),
          (d = parseAssignmentExpression(e, t, 0, 0, d, p, c, l))),
...
function parseExpressionOrLabelledStatement(e, t, n, r, o, s, a) {
  ...
  return (
    ...
    22 === e.token
      ? parseLabelledStatement(e, t, n, r, o, s, i, p, u, a, c, l, d)
      : ((u = parseMemberExpression(e, t, u, 0, 0, 0, c, l, d)),
        (u = parseAssignmentExpression(e, t, 0, 0, u, c, l, d)),
...
function parseModuleItemListAndDirectives(e, t, n) {
  ...
  if (32 & t)
    for (; 1572868 === e.token; ) {
      ...
      let p = parseLiteral(e, t);
      16777234 !== e.token && (p = parseNonDirectiveExpression(e, t, p, n, o, s)), consumeSemicolon(e, t);
      const c = a ? e.source.slice(e.start, e.index) : i,
        l = 'ExpressionStatement';
      r.push(
        2 & t
          ? { type: l, expression: p, directive: c, start: n, end: e.endIndex, loc: setLoc(e, o, s) }
...
function parseImportDeclaration(e, t) {
  ...
  if (1572868 === e.token) s = parseLiteral(e, t);
  else {
    if (2555904 & e.token) {
      const { start: p, line: c, column: l } = e,
      ...
      if (
        ...
        return (
          (s = parseModuleSpecifier(e, t)),
          consumeSemicolon(e, t),
          2 & t
            ? { type: i, specifiers: a, source: s, start: n, end: e.endIndex, loc: setLoc(e, r, o) }
            : { type: i, specifiers: a, source: s }
        );
      nextToken(e, t, 0);
    }
    switch (e.token) {
      case 135314230:
        const { start: s, line: i, column: p } = e;
        nextToken(e, t, 0),
          consume(e, t, 65646, 0),
          a.push(
            2 & t
      ...
      case 34603021:
        for (nextToken(e, t, 0); 2555904 & e.token; ) {
          const { start: n, line: r, column: o } = e,
            ...
            i = consumeOpt(e, t, 65646, 0) ? parseIdentifier(e, t) : s;
          a.push(
            2 & t
              ? { type: 'ImportSpecifier', local: i, imported: s, start: n, end: e.endIndex, loc: setLoc(e, r, o) }
              : { type: 'ImportSpecifier', local: i, imported: s }
          ),
...
function parseExportDefaultDeclaration(e, t, n, r, o, s) {
  nextToken(e, t, 1);
  let a = null;
  switch (e.token) {
    case 1179738:
    ...
    case 2162799:
      ...
      nextToken(e, t, 0),
        0 === e.newLine &&
          (1179738 === e.token
            ? (a = parseFunctionDeclarationRest(e, t, n, 5, 64, o, s, i))
            : ((a = parseIdentifierFromValue(e, t, r, o, s, i)),
              2162688 & e.token
...
function parseExportDeclaration(e, t, n) {
  ...
  switch (e.token) {
    case 131155:
      return parseExportDefaultDeclaration(e, t, n, r, o, s);
    case 135314230:
    ...
    case 34603021:
      for (nextToken(e, t, 0); 2555904 & e.token; ) {
        const { start: n, line: r, column: o } = e,
          s = parseIdentifier(e, t);
        let i;
        65646 === e.token ? (nextToken(e, t, 0), (i = parseIdentifier(e, t))) : (i = s),
          a.push(
            2 & t
              ? { type: 'ExportSpecifier', local: s, exported: i, start: n, end: e.endIndex, loc: setLoc(e, r, o) }
              : { type: 'ExportSpecifier', local: s, exported: i }
          ),
          16777232 !== e.token && consume(e, t, 19, 0);
      }
    ...
    case 2162799: {
      ...
      if ((nextToken(e, t, 0), 0 === e.newLine && 1179738 === e.token)) {
        i = parseFunctionDeclarationRest(e, t, n, 5, 64, r, o, s);
        break;
      }
    }
    default:
...
function parseModule(e, t) {
  ...
  const r = create(e);
  skipHashBang(r, e), nextToken(r, n, 1);
  const o = parseModuleItemListAndDirectives(r, 268435456 | n, { parent: void 0, type: 2 });
  return 2 & n
    ? {
        type: 'Program',
        sourceType: 'module',
