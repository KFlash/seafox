...
function addVarName(e, t, n, r, s) {
  ...
  for (; a && 0 == (128 & a.type); )
    (o = a['#' + r]),
      (244 & o) > 0 &&
        ((0 == (1040 & t) && (128 & s) > 0 && (6 & o) > 0) || ((128 & o) > 0 && (6 & s) > 0) || report(e, 22, r)),
      (1 & o) > 0 && (1 & s) > 0 && a === n && (a.scopeError = recordScopeError(e, 22, r)),
...
function parseBinaryExpression(e, t, n, r, s, o, a, i, p) {
  ...
  for (; (135266304 & s) > 0; ) {
    ...
    ((8388608 & s) | (1073741824 & l) | (8388608 & l) | (1073741824 & s)) > 1073741824 && report(e, 45),
      nextToken(e, t, 1),
...
function parseMemberExpression(e, t, n, r, s, o, a) {
  ...
  switch (e.token) {
    case 14: {
      nextToken(e, 512 | t, 0), (e.assignable = 1), 0 == (2555904 & e.token) && report(e, 95);
    ...
    case 1048586:
      return (
        (e.assignable = 0),
        parseMemberExpression(e, t, parseTemplateExpression(e, t, n, parseTemplateLiteral(e, t), s, o, a), r, s, o, a)
      );
    case 1048585:
      return parseMemberExpression(
        e,
...
function parseParenthesizedExpression(e, t, n, r, s, o, a, i, p) {
  nextToken(e, 512 | t, 1), (e.flags = 3328 ^ (3328 | e.flags)), (t = 8192 ^ (8192 | t));
  let l = [];
  if (17 === e.token)
    return (
      0 === r && report(e, 73),
  ...
  for (e.assignable = 1; 17 !== e.token; ) {
    ...
    if ((2555904 & r) > 0)
      ...
      if (!(33554432 & r)) {
        if (15 === r) {
          (l = parseSpreadOrRestElement(e, t, k, 17, 0, 0, 0, s, o, a, i, p)),
...
function parseClassElementList(e, t, n, r, s, o, a, i, p, l, c) {
  ...
  if ((2555904 & d) > 0) {
    if (((s = parseIdentifier(e, 512 | t)), 1048588 !== e.token))
      switch (d) {
        case 262252:
...
function parseFunctionDeclarationRest(e, t, n, r, s, o, a, i) {
  ...
  if (1048588 === e.token) 8 & r && report(e, 32, 'Function');
    ...
    validateFunctionName(e, t | ((3072 & t) << 11), o),
      4 & s && 2048 != (2048 & t) ? addVarName(e, t, n, a, 2) : addBlockName(e, t, n, a, 4, s),
    ...
    3473483 === i
      ? 0 != (36110336 & e.token)
        ...
        : (1024 & t && report(e, 40),
          ...
          (e.assignable = 1),
          (f = parseMemberExpression(e, t, f, 0, p, l, c)),
          (y = !0))
...
function parseForStatement(e, t, n, r) {
  ...
  if (1179722 === x || 3473483 === x || 1179724 === x)
    return parseForStatementWithVariableDeclarations(e, t, n, r, s, o, a);
  if (
    (33554432 == (33554432 & x)
      ? ((d =
          34603021 === x
