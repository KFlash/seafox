(function (global, factory) {
  ...
  function addVarName(parser, context, curScope, name, kind) {
      ...
      while (scope && (scope.type & 0b00000000000000000000000010000000) === 0) {
          ...
          if ((value & 0b00000000000000000000000000000001) > 0 &&
  ...
  function parseAssignmentExpression(parser, context, isPattern, inGroup, left, start, line, column) {
      if ((parser.token & 0b00000100000000000000000000000000) > 0) {
          if (parser.assignable === 0)
              report(parser, 60);
          return parseAssignmentOrPattern(parser, context, isPattern, inGroup, left, KeywordDescTable[parser.token & 0b00000000000000000000000011111111], start, line, column);
      }
  ...
  function parseBinaryExpression(parser, context, inGroup, minPrec, l, curStart, curLine, curColumn, left) {
      ...
      while ((l & 0b00001000000100000000000000000000) > 0) {
          t = parser.token;
          if ((t & prec) + ((t === 0b00001000000100001100110000111001) << 8) <= minPrec)
              return left;
          if (((l & 0b00000000100000000000000000000000) |
  ...
  function parseMemberExpression(parser, context, expr, inGroup, start, line, column) {
      ...
      switch (parser.token) {
          ...
          case 1048586: {
              parser.assignable = 0;
              return parseMemberExpression(parser, context, parseTemplateExpression(parser, context, expr, parseTemplateLiteral(parser, context), start, line, column), inGroup, start, line, column);
          }
          case 1048585: {
              return parseMemberExpression(parser, context, parseTemplateExpression(parser, context, expr, parseTemplate(parser, context | 65536, start, line, column), start, line, column), inGroup, start, line, column);
          }
          case 25: {
          ...
          if ((token & 0b00000000001001110000000000000000) > 0) {
              ...
              if (parser.token !== 19 && parser.token !== 17) {
                  ...
                  if ((parser.token & 0b00000100000000000000000000000000) > 0) {
                      if (parser.assignable === 0)
                          report(parser, 60);
                      expr = parseAssignmentOrPattern(parser, context, 0, 0, expr, KeywordDescTable[parser.token & 0b00000000000000000000000011111111], start, line, column);
                  }
              ...
              if ((token & 0b00000000001001110000000000000000) > 0) {
                  ...
                  if (parser.token === 67108896) {
                      ...
                      if ((parser.token & 0b00000100000000000000000000000000) > 0) {
                          if (parser.assignable === 0)
                              report(parser, 60);
                          left = parseAssignmentOrPattern(parser, context, isPattern, 0, left, KeywordDescTable[parser.token & 0b00000000000000000000000011111111], start, line, column);
                      }
                      else if ((parser.token & 0b00001000000100000000000000000000) > 0) {
                          mutualFlag |= 8;
      ...
      if (parser.token !== 17) {
          ...
          while (parser.token !== 17) {
              ...
              if ((parser.token & 0b00000000001001110000000000000000) > 0) {
                  ...
                  left = parseAndClassifyIdentifier(parser, context, scope, token, tokenValue, 1, 0, start, line, column, 0);
              }
              else {
                      ...
                      if ((parser.token & 0b00000000001001110000000000000000) > 0) {
                          ...
                          if (parser.token === 19 || parser.token === 16777232) {
                              ...
                              if ((parser.token & 67108864) === 67108864) {
                                  value = parseAssignmentOrPattern(parser, context, isPattern, 0, value, KeywordDescTable[parser.token & 0b00000000000000000000000011111111], start, line, column);
                              }
                              else {
                                  if ((parser.token & 0b00001000000100000000000000000000) > 0) {
                                      value = parseBinaryExpression(parser, context, 0, 0, parser.token, start, line, column, value);
  ...
  function parseFunctionDeclarationRest(parser, context, scope, flags, origin, start, line, column) {
      ...
      return parseFunctionLiteral(parser, ((context | 32243712) ^ 32243712) |
          67108864 |
