(function (global, factory) {
  ...
  function addBlockName(parser, context, scope, name, kind, origin) {
      ...
      if (scope.type & 64 && scope.parent['#' + name] &&
  ...
  function parseParenthesizedExpression(parser, context, inGroup, canAssign, kind, origin, curStart, curLine, curColumn) {
      ...
      if (parser.token === 11) {
          ...
          return parseArrowFunctionAfterParen(parser, context, scope, conjuncted, inSequence ? expressions : [expr], canAssign, 0, curStart, curLine, curColumn);
      }
  ...
  function parseClassElementList(parser, context, inheritedContext, conjuncted, key, isComputed, inGroup, type, curStart, curLine, curColumn) {
      ...
      if ((token & 0b00000000001001110000000000000000) > 0) {
          ...
          if (parser.token !== 1048588) {
              switch (token) {
                  case 262252:
                      if ((type & 32) === 0) {
                          return parseClassElementList(parser, context, inheritedContext, conjuncted, key, isComputed, inGroup, type | 32, start, line, column);
                      }
                      break;
                  case 2162799:
                      if (parser.newLine === 0) {
  ...
  function parseLabelledStatement(parser, context, scope, origin, labels, nestedLabels, value, token, expr, allowFuncDecl, start, line, column) {
      ...
      const body = (context & 0b00000000000000000000010000010000) > 0 || parser.token !== 1179738
