...
function isLineTerminator(code: number) {
  return ((unicodeLookup[(code >>> 5) + 69632] >>> code) & 31 & 1) !== 0;
}
function isZSpace(code: number) {
  return ((unicodeLookup[(code >>> 5) + 104448] >>> code) & 31 & 1) !== 0;
}
...
export { isIDContinue, isIDStart, isLineTerminator, isZSpace };
