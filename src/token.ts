export const enum Token {
  ...
  * KeywordDescTable array */
  ...
  IsMemberOrCallExpression = 0b00010000000000000000000000000000,
 ...
 /* Template nodes */
 TemplateCont      = 0b00010000000100000000000000001001,
 TemplateTail      = 0b00010000000100000000000000001010,

 /* Punctuators */
 Arrow              = 0b00000000000000000000000000001011, // =>
 LeftParen          = 0b00010000000100000000000000001100, // (
 LeftBrace          = 0b00000010000100000000000000001101, // {
 Period             = 0b00010000000000000000000000001110, // .
 ...
 LeftBracket        = 0b00010010000100000000000000010100, // [
 ...
 QuestionMarkPeriod = 0b00010000000000000000000000011001, // ?.
